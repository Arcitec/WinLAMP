#ifndef NULLSOFT_AUTH_LOGINCOMMAND_WINLAMPAUTH_HEADER
#define NULLSOFT_AUTH_LOGINCOMMAND_WINLAMPAUTH_HEADER
...
static const GUID LCUID_WINLAMPAUTH = 
{ 0x36b883c8, 0x5400, 0x4d43, { 0x89, 0xea, 0x96, 0xb1, 0xcb, 0xef, 0xc6, 0x5 } };


class LoginCommandWinLAMPAuth :	public LoginCommand								
{
protected:
	LoginCommandWinLAMPAuth();
	~LoginCommandWinLAMPAuth();

public:
	static HRESULT CreateInstance(LoginCommandWinLAMPAuth **instance);
...
#endif //NULLSOFT_AUTH_LOGINCOMMAND_WINLAMPAUTH_HEADER