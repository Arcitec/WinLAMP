#ifndef NULLSOFT_AUTH_LOGINRESULT_WINLAMPAUTH_HEADER
#define NULLSOFT_AUTH_LOGINRESULT_WINLAMPAUTH_HEADER
...
class LoginResultWinLAMPAuth : public LoginResult,
								public ifc_authcallback
{
protected:
	LoginResultWinLAMPAuth(api_auth *auth, LoginDataCredentials *pInput, Callback callback, void *user);
	~LoginResultWinLAMPAuth();

public:
	static HRESULT CreateInstance(LoginData *input, Callback callback, void *user, LoginResultWinLAMPAuth **instance);
...
private:
	...
	friend  static DWORD WINAPI WinLAMPAuth_ThreadProcCallback(void *param);
...
#endif //NULLSOFT_AUTH_LOGINRESULT_WINLAMPAUTH_HEADER