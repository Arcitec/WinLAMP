...
${LangFileString} installWinLAMPTop 			"Se va instala WinLAMP, ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}."
...
${LangFileString} uninstallPrompt	"WinLAMP se va dezinstala. Continuați?"
...
${LangFileString} msgRemoveMJUICE	"Eliminați suportul MJuice din sistemul Dvs.?$\r$\n$\r$\nSelectați Da numai dacă nu folosiți fișiere MJF și în alte programe decât WinLAMP."
...
${LangFileString} secML				"Mediatecă WinLAMP"
...
${LangFileString} IDS_GRP_WALIB				"Mediatecă WinLAMP"
...
${LangFileString} IDS_PAGE_FINISH_LINK				"Vizitați WinLAMP.com"
...
; start menu page
${LangFileString} IDS_PAGE_STARTMENU_TITLE				"Opțiuni de lansare WinLAMP"
${LangFileString} IDS_PAGE_STARTMENU_SUBTITLE			"Selectare opțiuni de lansare WinLAMP."
${LangFileString} IDS_PAGE_STARTMENU_CAPTION			"Alegeți oricare dintre următoarele opțiuni pentru a crea modalitățile de lansare WinLAMP."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Agentul WinLAMP nu poate fi închis.$\r$\n\
													Asigurați-vă că nici un alt utilizator nu a deschis o sesiune Windows.$\r$\n$\r$\n \
													După ce ați închis Agentul WinLAMP, selectați Reîncercare.$\r$\n$\r$\n	\
													Dacă totuși doriți să continuați instalarea oricum, selectați Ignorare.$\r$\n$\r$\n \
													Dacă doriți să abandonați instalarea, selectați Abandonare."
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"${DIRECTXINSTAL_WINLAMPNAME} necesită cel puțin ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} pentru a funcționa corect.$\r$\nÎl instalați acum?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"${DIRECTXINSTAL_WINLAMPNAME} necesită cel puțin ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} pentru a funcționa corect."
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"De pe computer lipsește o componentă ${DIRECTXINSTAL_DIRECTXNAME} necesară pentru ${DIRECTXINSTAL_WINLAMPNAME}."
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"Nucleu WinLAMP (necesar)"
${LangFileString} IDS_SEC_AGENT_DESC			"Componentă opțională - permite controlul WinLAMP din zona de notificare și menține asocierile tipurilor de fișiere"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Extensie pentru comenzile rapide globale - controlează WinLAMP de la tastatură când alte aplicații sunt active"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Suport pentru interfețele moderne - permite utilizarea interfețelor avansate cum ar fi WinLAMP Modern și Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC			"Colecție de instrumente și extensii WinLAMP"
${LangFileString} IDS_SEC_ML_DESC				"Mediatecă WinLAMP (necesar)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"Instrument de etichetare automată WinLAMP (dezvoltat de Gracenote) - completează automat datele extinse"
${LangFileString} IDS_SEC_ML_WIRE_DESC			"Director Podcast - permite abonarea și descărcarea podcast-urilor"
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Servicii internet - include serviciile SHOUTcast Radio && TV, AOL Radio feat. CBS Radio, WinLAMP Charts și altele"
...
${LangFileString} IDS_UNINSTALL_MEDIA_PLAYER 			"WinLAMP"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nNotă:  Nu toate fișierele au fost eliminate. Pentru a le vedea deschideți dosarul WinLAMP."
