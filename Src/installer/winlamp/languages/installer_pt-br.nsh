...
; Email:			contato.winlamp.br@gmail.com
...
${LangFileString} installWinLAMPTop "Você irá instalar o WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}. "
...
${LangFileString} uninstallPrompt "Você irá desinstalar o WinLAMP. Continuar?"
...
${LangFileString} msgCloseWinLAMP "Você deve fechar o WinLAMP antes de continuar.$\r$\n$\r$\n	Depois que você fechar o WinLAMP, clique em Tentar novamente.$\r$\n$\r$\n	Se desejar instalar de qualquer maneira, clique em Ignorar.$\r$\n$\r$\n	Se desejar cancelar a instalação, clique em Cancelar."
${LangFileString} msgInstallAborted "Instalação cancelada pelo usuário"

${LangFileString} secWinLAMP "WinLAMP (necessário)"
${LangFileString} compAgent "Agente do WinLAMP"
${LangFileString} compModernSkin "Suporte Skin Moderna"
${LangFileString} safeMode "WinLAMP (Modo de Segurança)"
...
${LangFileString} msgRemoveMJUICE "Remover suporte MJuice do seu sistema?$\r$\n$\r$\nSelecione SIM a menos que você use arquivos MJF em outros programas além do WinLAMP."
...
${LangFileString} secML "Biblioteca de Mídia do WinLAMP"
...
${LangFileString} IDS_GRP_WALIB				"Biblioteca do WinLAMP"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"Checando se há outra instância do WinLAMP em execução..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Clique aqui para visitar WinLAMP.com"
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA) permite você ouvir, assistir e gerenciar \
											...
											$\r$\n$\r$\n\
											Recursos inclusos:$\r$\n$\r$\n  \
											•  Sincronização sem fio de mídia com WinLAMP for Android$\r$\n$\r$\n  \
...
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"Clicando em “Próximo”, você aceita o <a id=$\"winlamp_eula$\">Termo de Licença</a> e <a id=$\"winlamp_privacy_policy$\">Política de Privacidade</a> do $(^NameDA)."
!else
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Escolha as seguintes opções para configurar seu WinLAMP nas opções do iniciar."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Não foi possível fechar o Agente do WinLAMP.$\r$\n\
                                                   Verifique se há outro usuário logado no Windows.\
                                                   $\r$\n$\r$\n	Depois de fechado o Agente do WinLAMP, clique em Repetir.\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"${DIRECTXINSTAL_WINLAMPNAME} requer a última versão ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} para trabalhar perfeitamente.$\r$\nInstale agora?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"${DIRECTXINSTAL_WINLAMPNAME} requer a última versão ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} para trabalhar perfeitamente"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"No seu computador está faltando ${DIRECTXINSTAL_DIRECTXNAME}, componente requerido por ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"WinLAMP (necessário)"
${LangFileString} IDS_SEC_AGENT_DESC			"Agente do WinLAMP, para acesso rápido pela bandeja do sistema e manutenção das associações de arquivos"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Plugin Teclas de Atalho Global, para controlar o WinLAMP com teclado multimídia sobre qualquer aplicação em foco"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Suporte a Skin Moderna, necessário para usar skins de formas livre como WinLAMP Modern e Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC			"Biblioteca do WinLAMP"
${LangFileString} IDS_SEC_ML_DESC				"Biblioteca de Mídia do WinLAMP (necessário)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"WinLAMP Auto-Tag (Fornecido por Gracenote), para preenchimento de metadados inválido/ausente."
${LangFileString} IDS_SEC_ML_WIRE_DESC			"Diretório Podcast, para subscrever e baixar podcasts"
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Serviços Online, incluindo Rádio SHOUTcast && TV, Rádio AOL pela Rádio CBS, WinLAMP Charts, etc"
${LangFileString} IDS_SEC_ML_PLG_DESC			"Gerador de Playlist do WinLAMP (Fornecido por Gracenote), para criação de playlists dinâmicas"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nNota:  Nem todos os arquivos foram removidos. Para removê-los, abra a pasta do WinLAMP."
