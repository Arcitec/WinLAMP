...
${LangFileString} installWinLAMPTop "這會安裝 WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}。"
...
${LangFileString} secML "WinLAMP 媒體櫃"
...
${LangFileString} IDS_GRP_WALIB				"WinLAMP 程式庫"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"檢查是否有另一個 WinLAMP 作業正在執行..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"按一下此處以造訪 WinLAMP.com"
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"請選擇下列選項以設定您的 WinLAMP 開始選項。"
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"無法關閉 WinLAMP Agent。$\r$\n\
請確認無其他使用者登入 Windows。\
$\r$\n$\r$\n	關閉 WinLAMPAgent 後，選取 [重試]。\
$\r$\n$\r$\n	如果仍然要繼續安裝，請選取 [忽略]。\
$\r$\n$\r$\n	若要中止安裝程序，請選取 [中止]。"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"WinLAMP 核心 (要求使用)"
${LangFileString} IDS_SEC_AGENT_DESC			"WinLAMP Agent，可快速存取系統匣並維持檔案類型關聯性"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"全域快速鍵外掛程式，可在專注於其他應用程式時透過鍵盤控制 WinLAMP"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"新式面板支援，使用例如 WinLAMP Modern 及 Bento 等手繪面板必備功能"
...
${LangFileString} IDS_GRP_WALIB_DESC			"WinLAMP 程式庫"
${LangFileString} IDS_SEC_ML_DESC				"WinLAMP 媒體櫃 (要求使用)"
${LangFileString} IDS_SEC_ML_TRANSCODE_DESC		"轉碼工具，可將一個檔案格式轉換成另一檔案格式"
${LangFileString} IDS_SEC_ML_RG_DESC			"重新播放音量差異分析工具，可用於音量分級"
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"WinLAMP Auto-Tagger (由 Gracenote 提供)，可補足遺失的詮釋資料"
...
${LangFileString} IDS_SEC_ML_PLG_DESC			"WinLAMP 播放清單產生器 (由 Gracenote 提供)，可建立動態音響播放清單"
