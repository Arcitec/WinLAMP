...
${LangFileString} installWinLAMPTop "WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType} kommer att installeras.  " 
...
${LangFileString} uninstallPrompt "WinLAMP kommer att avinstalleras. Vill du fortsätta?"
...
${LangFileString} secML "WinLAMP-mediebiblioteket"
...
${LangFileString} IDS_GRP_WALIB				"WinLAMP-biblioteket"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"Kontrollerar om en annan instans av WinLAMP är igång..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Klicka här för att gå till WinLAMP.com"
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"Nu kan du uppleva den optimala mediehanteraren och mycket mer.$\r$\n$\r$\n\
                          ...
                          videofilmer, recensioner och mycket mer. $\r$\n  \
													...
													•  Stöd för skivomslag - WinLAMP hittar det åt dig!$\r$\n  \
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Välj bland följande alternativ för att konfigurera startalternativen för WinLAMP."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Det går inte att stänga WinLAMP-agenten.$\r$\n\
                                                   Kontrollera att inte någon annan är inloggad i Windows.\
                                                   $\r$\n$\r$\n	Välj Försök igen när du har stängt WinLAMP-agenten.\
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"WinLAMP-kärnan (nödvändigt)"
${LangFileString} IDS_SEC_AGENT_DESC			"WinLAMP-agenten förenklar tillgången till systemfältet och underhåller filtypsassociationer"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Plugin-programmet Globala snabbtangenter för styrning av WinLAMP från tangentbordet när andra program är aktiva"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Stöd för moderna skal, krävs för frihandsskal som WinLAMP Modern och Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC			"WinLAMP-biblioteket"
${LangFileString} IDS_SEC_ML_DESC				"WinLAMP-mediebibliotek (nödvändigt)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"WinLAMPs funktion för automatisk taggning (utformad av Gracenote) kompletterar saknade metadata"
