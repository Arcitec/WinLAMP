...
${LangFileString} installWinLAMPTop "Zainstalowany zostanie program WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}. "
...
${LangFileString} uninstallPrompt "Program WinLAMP zostanie odinstalowany. Kontynuować?"
...
${LangFileString} secML "Biblioteka mediów WinLAMPa"
...
${LangFileString} IDS_GRP_WALIB				"Biblioteka WinLAMPa"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"Sprawdzanie, czy uruchomione jest inne wystąpienie programu WinLAMP..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Kliknij tutaj, aby odwiedzić witrynę WinLAMP.com"
...
;											•  Synchronizuj bezprzew. media z WinLAMP for Android$\r$\n$\r$\n  \
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA) pozwala na odtwarzanie oraz zarządzanie utworów biblioteki multimediów, słuchanie radia internetowego SHOUTcast i wiele więcej.$\r$\n$\r$\n\
											Korzystaj z poniższych funkcjonalności:$\r$\n$\r$\n  \
											•  Mnóstwo niesamowitych funkcji WinLAMPa$\r$\n$\r$\n  \
											•  Ta kompilacja nie jest pełną kompilacją, wkrótce więcje...$\r$\n$\r$\n  \
											•  NIE UDOSTĘPNIAJ TEJ KOMPILACJI NIKOMU!"
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"Klikając przycisk „Dalej”, zgadzasz się z <a id=$\"winlamp_eula$\">Umową licencyjną</a> oraz <a id=$\"winlamp_privacy_policy$\">Polityką prywatności</a> WinLAMPa."
!else
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Dokonaj wyboru spośród następujących opcji, aby skonfigurować ustawienia uruchamiania WinLAMPa."
...
; Messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Nie można zamknąć Agenta WinLAMPa.$\r$\n\
                                                   Upewnij się, że w systemie Windows nie jest zalogowany inny użytkownik.\
                                                   $\r$\n$\r$\n	Po zamknięciu Agenta WinLAMPa, kliknij przycisk Ponów próbę.\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"Aby działać prawidłowo instalator ${DIRECTXINSTAL_WINLAMPNAME} wymaga programu w wersji co najmniej ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER}.$\r$\nZainstalować ją teraz?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"Aby działać prawidłowo instalator ${DIRECTXINSTAL_WINLAMPNAME} wymaga programu w wersji co najmniej ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER}"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"Na komputerze nie znaleziono składnika ${DIRECTXINSTAL_DIRECTXNAME} wymaganego przez ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"Pliki główne programu WinLAMP (wymagane)"
${LangFileString} IDS_SEC_AGENT_DESC			"Agent WinLAMPa zapewnia szybki dostęp z zasobnika systemowego i zarządza skojarzeniami z typami plików"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Wtyczka globalnych klawiszy skrótów, umożliwia sterowanie WinLAMPem, gdy aktywne są inne aplikacje"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Obsługa skórek nowoczesnych (dla skórek o dowolnym wyglądzie, typu WinLAMP Modern lub WinLAMP Bento)"
...
${LangFileString} IDS_GRP_WALIB_DESC			"Biblioteka WinLAMPa"
${LangFileString} IDS_SEC_ML_DESC				"Biblioteka mediów WinLAMPa (wymagane)"
...
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Usługi Online, w tym strumienie radiowe i telewizyjne SHOUTcast, Radio AOL z Radio CBS, statystki WinLAMPa i wiele więcej"
...
${LangFileString} IDS_UNINSTALL_MEDIA_PLAYER_DESC 		"Odinstaluj wszystkie składniki odtwarzacza $(^NameDA) (łącznie z wtyczkami innych wydawców rozprowadzanymi z WinLAMPem)."
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nUwaga: Nie wszystkie pliki zostały odinstalowane. Aby je zobaczyć, otwórz katalog WinLAMPa."
