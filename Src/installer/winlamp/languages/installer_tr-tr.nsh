...
${LangFileString} installStandard "Standart"
...
${LangFileString} installWinLAMPTop "Bu, WinLAMP'ın ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType} sürümünü kuracak."
${LangFileString} installerContainsFull " Bu kurulum WinLAMP'ın tam sürümünü içerir."
${LangFileString} installerContainsLite " Bu kurulum WinLAMP'ın lite sürümünü içerir."
${LangFileString} licenseTop "Kuruluma başlamadan önce aşağıdaki lisans anlaşmasını okuyun ve kabul edin."
${LangFileString} directoryTop "Kur, WinLAMP'ın kurulacağı en uygun konumu belirledi. Eğer başka bir konuma kurmak isterseniz Gözat'a tıklatın ve başka bir konum seçin."

${LangFileString} uninstallPrompt "WinLAMP kaldırılacak. Devam etmek istiyor musunuz?"
...
${LangFileString} msgCloseWinLAMP "Devam edebilmeniz için WinLAMP'ı kapatmalısınız.$\r$\n$\r$\n	WinLAMP'ı kapatın ve Yeniden Dene'yi tıklatın.$\r$\n$\r$\n	Bunu atlamak ve devam etmek için Yoksay'ı tıklatın.$\r$\n$\r$\n	Kurulumu iptal etmek için Durdur'u tıklatın."
${LangFileString} msgInstallAborted "Kurma işlemi kullanıcı tarafından iptal edildi"

${LangFileString} secWinLAMP "WinLAMP (gerekli)"
${LangFileString} compAgent "WinLAMP Ajanı"
${LangFileString} compModernSkin "Modern Dış Görünüm Desteği"
${LangFileString} safeMode "WinLAMP (Güvenli Kip)"
${LangFileString} uninstallWinLAMP "WinLAMP Kaldır"
...
${LangFileString} secML "WinLAMP Ortam Dosyası"
...
${LangFileString} IDS_GRP_WALIB				"WinLAMP Kitaplığı"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"Çalışan başka bir WinLAMP kopyası veya bir bileşeni olup olmadığı denetleniyor..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"WinLAMP.com'u ziyaret etmek için buraya tıklatın"
...
!ifdef EXPRESS_MODE
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA) müzik, podcast, internet radyolarını dinlemenizi, \
											video izlemenizi ve ortam kitaplığınızı yönetmenizi sağlar.  \
											Evde, işte, arabada dinleyin.$\r$\n$\r$\n\
											Özelliklerden Bazıları:$\r$\n$\r$\n  \
											•  Android uygulamaları için WinLAMP ile kablosuz eşitleme$\r$\n$\r$\n  \
...
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"'İleri' düğmesine tıklamak, $(^NameDA) <a id=$\"winlamp_eula$\">Son Kullanıcı Lisans Sözleşmesi</a> ve <a id=$\"winlamp_privacy_policy$\">Gizlilik İlkesi</a>'ni kabul etmiş sayılırsınız."
!else
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA), ortam kitaplığını yönetmenizi ve internet radyosu dinlemenizi sağlar.$\r$\n$\r$\n\
											Özelliklerden Bazıları:$\r$\n$\r$\n  \
											•  Android uygulamaları için WinLAMP ile kablosuz eşitleme$\r$\n$\r$\n  \
											•  Otomatik Etiketleme özelliğini kullanarak ortam meta$\r$\n      \
											   verilerini otomatik olarak alabilme$\r$\n$\r$\n  \
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"WinLAMP için oluşturmak istediğiniz kısayolları seçin."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"WinLAMP Ajanı kapatılamadı.$\r$\n\
                                                   Başka bir kullanıcı için yapılandırılmadığından emin olun.\
                                                   $\r$\n$\r$\n	WinLAMP Ajanı'nı kapatın ve Yeniden Dene'yi tıklatın.\
                                                   $\r$\n$\r$\n	WinLAMP Ajanı'nı yoksayıp devam etmek için Yoksay'ı tıklatın. \
                                                   $\r$\n$\r$\n	Kurulumu iptal etmek için Durdur'u tıklatın."
...
${LangFileString} IDS_LYRICS_PLUGIN_WARNING     "3. parti gen_lyrics eklentisi algılandı!$\r$\n$\r$\nBu eklentinin eski sürümleri WinLAMP 5.6 ve daha yeni sürümleri için uyumsuzdur. Devam etmeden önce http://lyricsplugin.com adresinden eklentinin son sürümüne sahip olduğunuzdan emin olun."
${LangFileString} IDS_LYRICS_IE_PLUGIN_DISABLE	"Uyumsuz 3. parti gen_lyrics_ie.dll eklentisi algılandı!$\r$\n$\r$\nBu eklenti WinLAMP'in çokmesine neden olur.$\r$\nEklenti şimdi devre dışı bırakılacak. Devam etmek için Tamam'ı tıklatın."
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"${DIRECTXINSTAL_WINLAMPNAME} en az ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} sürümüne ihtiyaç duyar.$\r$\nŞimdi indirmek istiyor musunuz?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"${DIRECTXINSTAL_WINLAMPNAME} en az ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} sürümüne ihtiyaç duyar"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"Bilgisayarınızda ${DIRECTXINSTAL_WINLAMPNAME} için gerekli ${DIRECTXINSTAL_DIRECTXNAME} bileşeni eksik"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"WinLAMP (gerekli)"
${LangFileString} IDS_SEC_AGENT_DESC			"WinLAMP Ajanı, hızlı erişim için görev çubuğunda simge gösterir ve WinLAMP ile ilişkilendirilmiş dosya türlerini korur"
...
${LangFileString} IDS_SEC_OGG_DEC_DESC			"Ogg Vorbis biçimi (OGG, OGA) için kayıttan yürütme desteği"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Genel Kısayollar eklentisi, WinLAMP'ı kısayollar aracılığıyla yönetmenizi sağlar"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"WinLAMP Modern ve Bento dış görünümler gibi serbest formlar kullanan dış görünümler için gereklidir"
...
${LangFileString} IDS_GRP_WALIB_DESC			"WinLAMP Kitaplığı"
${LangFileString} IDS_SEC_ML_DESC				"WinLAMP Ortam Kitaplığı (gerekli)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"WinLAMP Otomatik Etiketleyici (Gracenote destekli), eksik meta verileri doldurma desteği sağlar"
${LangFileString} IDS_SEC_ML_WIRE_DESC			"Podcast Dizini, podcast yayınlarına abone olma ve indirme desteği sağlar"
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Çevrimiçi Servisler, SHOUTcast Radyo & TV, AOL Radio, CBS Radio, WinLAMP Charts ve daha fazlası"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nNot: Tüm dosyalar kaldırılamadı. İçeriği görmek için WinLAMP klasörünü açın."

!ifdef EXPRESS_MODE
${LangFileString} IDS_EXPRESS_MODE_HEADER "$(^NameDA) Kurulum Türü"
${LangFileString} IDS_EXPRESS_MODE_SUBHEADER "Kurulum Türünü Seçin"
${LangFileString} IDS_EXPRESS_MODE_STANDARD_INSTALL_RADIO "&Varsayılan Kurulum"
${LangFileString} IDS_EXPRESS_MODE_STANDARD_INSTALL_TEXT "Bu seçenek $(^NameDA)'ı önerilen bileşenler ile şu konumuna kuracak:$\r$\n\
                                                          '$INSTDIR'"
${LangFileString} IDS_EXPRESS_MODE_STANDARD_REINSTALL_TEXT "Bu seçenek $(^NameDA)'ı önceden seçilmiş bileşenler ile şu konuma kuracak:$\r$\n\
                                                          '$INSTDIR'"
${LangFileString} IDS_EXPRESS_MODE_CUSTOM_INSTALL_RADIO "Ö&zel Kurulum"
${LangFileString} IDS_EXPRESS_MODE_CUSTOM_INSTALL_TEXT "Özel kurulum, yüklemek istediğiniz bileşenleri el ile seçerek $(^NameDA)'ı$\r$\n\
                                                        kurmanızı sağlar."
!endif ; defined (EXPRESS_MODE) 