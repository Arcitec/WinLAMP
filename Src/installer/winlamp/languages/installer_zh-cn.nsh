...
${LangFileString} installWinLAMPTop "这将安装 WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}。"
...
${LangFileString} secML "WinLAMP 媒体库"
...
${LangFileString} IDS_GRP_WALIB				"WinLAMP 媒体库"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"正在检查是否有 WinLAMP 的另一个实例正在运行..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"单击此处以访问 WinLAMP.com"
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"从以下选项中选择以配置您的 WinLAMP 启动选项。"
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"无法关闭 WinLAMP Agent。$\r$\n\
确保没有其他用户登录到 Windows。\
$\r$\n$\r$\n	关闭 WinLAMPAgent 后，选择“重试”。\
$\r$\n$\r$\n	如果要尝试继续安装，请选择“忽略”。\
$\r$\n$\r$\n	如果要中止安装过程，请选择“中止”。"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"WinLAMP 核心(必需)"
${LangFileString} IDS_SEC_AGENT_DESC			"WinLAMP Agent，用于快速系统托盘访问和维护文件类型关联"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"全局热键插件，用于在其他应用程序处于焦点时使用键盘控制 WinLAMP"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"现代面板支持，使用任意形状的面板(例如 WinLAMP 现代和 Bento)所必需的"
...
${LangFileString} IDS_GRP_WALIB_DESC			"WinLAMP 媒体库"
${LangFileString} IDS_SEC_ML_DESC				"WinLAMP 媒体库(必需)"
${LangFileString} IDS_SEC_ML_TRANSCODE_DESC		"代码转换工具，用于从一种文件格式转换为另一种文件格式"
${LangFileString} IDS_SEC_ML_RG_DESC			"回放增益分析工具，用于设置音量级别"
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"WinLAMP 自动标记(由 Gracenote 提供技术支持)，用于填入缺少的元数据"
...
${LangFileString} IDS_SEC_ML_PLG_DESC			"WinLAMP 播放列表生成器(由 Gracenote 提供技术支持)，用于创建声音动态播放列表"
