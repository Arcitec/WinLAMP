...
; Comments: This is the Indonesian WinLAMP Installer
...
${LangFileString} installWinLAMPTop "Ini akan memasang WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}. "
...
${LangFileString} uninstallPrompt "Ini akan menghapus WinLAMP. Lanjutkan?"
...
${LangFileString} msgCloseWinLAMP "Anda harus menutup WinLAMP sebelum Anda bisa melanjutkan.$\r$\n$\r$\n	Setelah Anda telah menutup WinLAMP, pilih Coba lagi.$\r$\n$\r$\n	Jika Anda ingin mencoba untuk memasang bagaimanapun, pilih Abaikan.$\r$\n$\r$\n	Jika Anda ingin membatalkan pemasangan, pilih Batalkan."
${LangFileString} msgInstallAborted "Pemasangan dibatalkan oleh pengguna"

${LangFileString} secWinLAMP "WinLAMP (Wajib)"
${LangFileString} compAgent "Agen WinLAMP"
${LangFileString} compModernSkin "Dukungan Kulit Modern"
${LangFileString} safeMode "WinLAMP (Mode Aman)"
${LangFileString} uninstallWinLAMP "Hapus WinLAMP"
...
${LangFileString} msgRemoveMJUICE "Hapus dukungan MJuice dari sistem Anda?$\r$\n$\r$\nPilih YA kecuali jika Anda menggunakan berkas MJF pada program lainnya selain WinLAMP."
...
${LangFileString} secML "Perpustakaan Media WinLAMP"
...
${LangFileString} IDS_GRP_WALIB				"Perpustakaan WinLAMP"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"Memeriksa apakah instansi lain dari WinLAMP berjalan..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Klik disini untuk mengunjungi WinLAMP.com"
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA) memungkinkan Anda untuk mendengarkan, melihat \
											 ...
											 $\r$\n$\r$\n$\r$\n\
											 Fitur termasuk :$\r$\n$\r$\n  \
											 •  Sinkron media ke aplikasi WinLAMP untuk Android secara$\r$\n      \
											    nirkabel$\r$\n$\r$\n  \
...
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"Dengan mengeklik “Selanjutnya”, Anda menyetujui <a id=$\"winlamp_eula$\">Perjanjian Lisensi</a> dan <a id=$\"winlamp_privacy_policy$\">Kebijakan Privasi</a> $(^NameDA)."
!else
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Pilih dari opsi berikut untuk mengkonfigurasi opsi mulai WinLAMP."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Tidak dapat menutup Agen WinLAMP.$\r$\n\
                                                   Pastikan bahwa pengguna lain tidak masuk ke Windows.\
                                                   $\r$\n$\r$\n	Setelah Anda menutup Agen WinLAMP, pilih Coba lagi.\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"${DIRECTXINSTAL_WINLAMPNAME} membutuhkan setidaknya ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} untuk beroperasi dengan baik.$\r$\nPasang itu sekarang?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"${DIRECTXINSTAL_WINLAMPNAME} membutuhkan setidaknya ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} untuk berfungsi dengan baik"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"Komputer Anda kehilangan komponen ${DIRECTXINSTAL_DIRECTXNAME} yang diperlukan oleh ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"Inti WinLAMP (wajib)"
${LangFileString} IDS_SEC_AGENT_DESC			"Agen WinLAMP, untuk akses cepat baki sistem dan mempertahakan asosiasi jenis berkas"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Plugin Tombol Pintas Umum, untuk mengendalikan WinLAMP dengan keyboard ketika aplikasi lain dalam fokus"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Dukungan Kulit Modern, diperlukan untuk menggunakan kulit bentuk yang unik seperti WinLAMP Modern dan Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC			"Perpustakaan WinLAMP"
${LangFileString} IDS_SEC_ML_DESC				"Perpustakaan Media WinLAMP (wajib)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"Otomatis Penanda WinLAMP (Didukung oleh Gracenote), untuk mengisi metadata yang hilang"
${LangFileString} IDS_SEC_ML_WIRE_DESC			"Direktori Podcast, untuk berlangganan dan mengunduh podcast"
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Layanan Online, termasuk SHOUTcast Radio && TV, AOL Radio feat. CBS Radio, WinLAMP Charts, dan banyak lagi"
${LangFileString} IDS_SEC_ML_PLG_DESC			"Pembuat Daftar Putar WinLAMP (didukung oleh Gracenote), untuk membuat daftar putar secara akustik"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nCatatan : Tidak semua berkas telah dihapus dari penghapusan ini. Untuk melihat, buka folder WinLAMP."
