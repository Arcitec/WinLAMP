...
; 05.10 > barabanger:  in IDS_SEC_FREEFORM_DESC WinLAMP Bento changed to  "Bento"
...
; 14.01 > barabanger: changed winlamp remote bundle text (IDS_BUNDLE1_DESCRIPTION).
; 20.03 > barabanger: added toolbar search (IDS_BUNDLE21_XXX).
; 21.03 > barabanger: added winlamp search (IDS_WINLAMP_SEARCH).
...
; 24.11 > djegg: added WinLAMP3 section for upgrade messages
...
; nov 12 2010 > barabanger: Commented-out WinLAMP Remote from bundle page (line 321)
...
${LangFileString} installWinLAMPTop "Ceci installera la version ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}. "
...
${LangFileString} uninstallPrompt "Ceci désinstallera WinLAMP. Voulez-vous continuer ?"
...
${LangFileString} msgCloseWinLAMP "Veuillez préalablement fermer WinLAMP avant de continuer.$\r$\n$\r$\nAprès avoir fermé WinLAMP, veuillez sélectionner Réessayer.$\r$\n$\r$\nSi vous souhaitez tout de même essayer de continuer, sélectionnez Ignorer.$\r$\n$\r$\nSi vous souhaitez annuler l'installation, sélectionnez Abandonner."
${LangFileString} msgInstallAborted "Installation abandonnée par l'utilisation"

${LangFileString} secWinLAMP "WinLAMP (requis)"
${LangFileString} compAgent "Agent WinLAMP"
${LangFileString} compModernSkin "Support des skins modernes"
${LangFileString} uninstallWinLAMP "Désinstaller WinLAMP"
...
${LangFileString} msgRemoveMJUICE "Voulez-vous vraiment enlever le support MJuice de votre système ?$\r$\n$\r$\nSélectionnez OUI à moins que vous n'utilisiez des fichiers MJF dans des programmes autre que WinLAMP."
...
${LangFileString} secML "Médiathèque WinLAMP"
...
${LangFileString} IDS_GRP_WALIB				"Médiathèque WinLAMP"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"Vérification de la présence d'une autre instance de WinLAMP en cours d'exécution..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Cliquez ici pour visiter WinLAMP.com"
...
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"En cliquant sur “Suivant”, vous acceptez les <a id=$\"winlamp_eula$\">Accords de licence</a> ainsi que la <a id=$\"winlamp_privacy_policy$\">politique de confidentialité</a> de $(^NameDA)."
!else
...
${LangFileString} IDS_PAGE_STARTMENU_SUBTITLE		"Choisissez les différents raccourcis vers WinLAMP à créer."
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Veuillez sélectionner, parmis les possibilités suivantes, les différents raccourcis vers WinLAMP à créer."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Impossible de fermer l'Agent WinLAMP.$\r$\n\
                                                   Vérifiez qu'un autre utilisateur n'est pas connecté sur Windows.\
                                                   $\r$\n$\r$\n	Après avoir fermé l'Agent WinLAMP, sélectionnez Réessayer.\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"${DIRECTXINSTAL_WINLAMPNAME} requiert au moins ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} pour fonctionner correctement.$\r$\nVoulez-vous l'installer dès maintenant ?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"${DIRECTXINSTAL_WINLAMPNAME} requiert au moins ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} pour fonctionner correctement"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"Votre ordinateur ne possède pas un composant de ${DIRECTXINSTAL_DIRECTXNAME} requis par ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"Noyau WinLAMP (requis)"
${LangFileString} IDS_SEC_AGENT_DESC			"Ajoute une icône WinLAMP près de l'horloge, et maintient l'association entre WinLAMP et les fichiers multimédia"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Permet le contrôle de WinLAMP depuis votre clavier alors que vous travaillez avec d'autres applications"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Support des skins modernes, requis pour l'utilisation des skins avancés comme WinLAMP Modern et Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC			"Médiathèque WinLAMP"
${LangFileString} IDS_SEC_ML_DESC				"Médiathèque WinLAMP (requise)"
...
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Services Internet, incluant SHOUTcast Radio && TV, In2TV, AOL Radio avec CBS Radio, les Charts WinLAMP et d'autres encore"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nNote : Tous les fichiers n'ont pas pu être supprimés pendant la désinstallation. Pour les afficher, ouvrez le dossier de WinLAMP."
