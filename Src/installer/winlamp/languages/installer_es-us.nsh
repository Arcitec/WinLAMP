...
; Comments: Spanish WinLAMP is back!
;History:
...
;16-01-2008 >> changed winlamp remote bundle text (IDS_BUNDLE1_DESCRIPTION).
;18-01-2008 >> Fixed typos (plurals, etc)
;23-03-2008 >> added toolbar search (IDS_BUNDLE21_XXX) (note: subject to change)
;23-03-2008 >> barabanger: added winlamp search (IDS_WINLAMP_SEARCH).
...
;06-01-2009 >> Manuel: added WinLAMP3 section for upgrade messages, lines 287-292 & added localized "built on" and "at" strings for branding text (lines 48-50)
;12-11-2009 >> A lot of Actualizations :-)
;06-12-2009 >> added DirectX section
;13-12-2009 >> Updated some strings
;16-12-2010 >> Darwin: Added IDS_UNINSTALL_XXX, Translation for winlamp 5.61+
...
${LangFileString} installWinLAMPTop "Se instalará WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}."
...
${LangFileString} uninstallPrompt "Esta acción desinstalará WinLAMP. ¿Desea continuar?"
...
${LangFileString} msgCloseWinLAMP "Debe cerrar WinLAMP antes de continuar.$\r$\n$\r$\n	Después de cerrar WinLAMP, seleccione Reintentar.$\r$\n$\r$\n	Si desea intentar la instalación de todas maneras, seleccione Omitir.$\r$\n$\r$\n	Si desea anular la instalación, seleccione Anular."
${LangFileString} msgInstallAborted "Instalación anulada por el usuario"

${LangFileString} secWinLAMP "WinLAMP (requerido)"
${LangFileString} compAgent "Agente de WinLAMP"
${LangFileString} compModernSkin "Compatibilidad con Carátulas Modernas"
${LangFileString} uninstallWinLAMP "Desinstalar WinLAMP"
...
${LangFileString} secML "Biblioteca Multimedia de WinLAMP"
...
${LangFileString} IDS_GRP_WALIB				"Biblioteca de WinLAMP"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"Comprobando si se está ejecutando otra instancia de WinLAMP..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Haga clic aquí para visitar WinLAMP.com"
...
${LangFileString} IDS_PAGE_WELCOME_TEXT			"$(^NameDA) te permite escuchar, ver y administrar toda tu Biblioteca Musical.\
												...
												•  Sincronización inalámbrica de medios usando la app de WinLAMP para Android$\r$\n  \
...
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"Al hacer clic en “siguiente”, está aceptando la <a id=$\"winlamp_eula$\">Acuerdo de Licencia</a> y <a id=$\"winlamp_privacy_policy$\">los términos de privacidad de</a> $(^NameDA)."
!else
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Seleccione una de las siguientes opciones para configurar las preferencias de WinLAMP."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"No es posible cerrar el agente de WinLAMP.$\r$\n\
                                                   Asegúrese de que no hay otro usuario conectado a Windows.\
                                                   $\r$\n$\r$\n	Después de cerrar el agente de WinLAMP, seleccione Reintentar.\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"${DIRECTXINSTAL_WINLAMPNAME} requiere al menos ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} para funcionar correctamente.$\r$\nInstalar ahora?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"${DIRECTXINSTAL_WINLAMPNAME} requiere al menos ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} para funcionar correctamente"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"Su computador no tiene instalado ${DIRECTXINSTAL_DIRECTXNAME} que es un componente requerido por ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"Nucleo de WinLAMP (requerido)"
${LangFileString} IDS_SEC_AGENT_DESC			"El agente de WinLAMP permite un acceso rápido a la bandeja del sistema y mantiene las asociaciones."
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Complemento de teclas de acceso rápido, controla WinLAMP con el teclado cuando otras aplicaciones están activas."
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Compatibilidad con carátulas modernas, necesario para usar carátulas innovadoras, como WinLAMP Modern y Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC			"Biblioteca WinLAMP"
${LangFileString} IDS_SEC_ML_DESC				"Biblioteca Multimedia de WinLAMP (requerida)"
...
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Servicios en línea que incluyen SHOUTCast Radio y TV.AOL RADIO, CBS RADIO, WinLAMP charts y más..."
${LangFileString} IDS_SEC_ML_PLG_DESC			"Generador de listas de reprodución WinLAMP (Provisto por Gracenote), crea listas de reproducción dinámicas"
...
${LangFileString} IDS_SEC_ML_ADDONS_DESC		"Descubra y agruegue extensiones a su WinLAMP con agregados (addons)"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nNota: No todos los archivos fueron eliminados en esta desinstalación. Para visualizar, abra la carpeta de WinLAMP"
