...
; nov 12 2010 > barabanger: Commented-out WinLAMP Remote from bundle page (line 324)
...
${LangFileString} installWinLAMPTop "Questo programma installerà WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}."
...
${LangFileString} uninstallPrompt "Questo disinstallerà WinLAMP. Vuoi continuare?"
...
${LangFileString} msgRemoveMJUICE "Si vuole rimuovere il supporto MJuice dal sistema?$\r$\n$\r$\nSeleziona SÌ a meno che non si utilizzano file MJF in programmi diversi da WinLAMP."
...
${LangFileString} secML "Libreria multimediale di WinLAMP"
...
${LangFileString} IDS_GRP_WALIB				"Libreria di WinLAMP"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"Verifica per determinare se è in esecuzione un'altra istanza di WinLAMP..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Clicca qui per visitare il sito WinLAMP.com"
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA) permette di ascoltare, guardare e gestire la musica, i video, i podcast e internet radio.$\r$\n$\r$\n$\r$\nCaratteristiche inclusi:$\r$\n$\r$\n  \
													...
													•  Controlla la riproduzione nel browser con WinLAMP Toolbar$\r$\n$\r$\n  \
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Scegli tra le seguenti opzioni per configurare le opzioni d'avvio di WinLAMP"
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Impossibile terminare WinLAMP Agent.$\r$\n\
                                                   Essere certi che un altro utente non sia loggatto su Windows.\
                                                   $\r$\n$\r$\n	Dopo aver chiuso WinLAMPAgent, seleziona Riprova.\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"${DIRECTXINSTAL_WINLAMPNAME} richiede almeno ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} per farlo funzionare correttamente.$\r$\nInstallare proprio adesso?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"${DIRECTXINSTAL_WINLAMPNAME} richiede almeno ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} per farlo funzionare correttamente"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"Il computer è mancante di un componente ${DIRECTXINSTAL_DIRECTXNAME} richiesto da ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"WinLAMP core (richiesto)"
${LangFileString} IDS_SEC_AGENT_DESC			"Agent di WinLAMP, per un accesso rapido all'area di notifica e la gestione delle associazioni dei tipi di file"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Plugin tasti rapidi globali, per controllare WinLAMP con la tastiera quando sono attive altre applicazioni"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Supporto per interfaccia Modern, richiesto per l'utilizzo di interfacce a mano libera come WinLAMP Modern e Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC			"Libreria di WinLAMP"
${LangFileString} IDS_SEC_ML_DESC				"Libreria multimediale di WinLAMP (richiesta)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"WinLAMP Auto-Tagger (sviluppato da Gracenote), per l'inserimento di metadati mancanti"
${LangFileString} IDS_SEC_ML_WIRE_DESC			"Directory podcast, per la sottoscrizione e il download di podcast"
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Servizi online, includendo SHOUTcast Radio && TV, AOL Radio feat. CBS Radio, WinLAMP Charts, e altro"
${LangFileString} IDS_SEC_ML_PLG_DESC			"Generatore di playlist WinLAMP (sviluppato da Gracenote), per la creazione di playlist acusticamente dinamiche)"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nNota:  Non tutti i file sono stati rimossi da questa disinstallazione. Per visualizzare, aprire la cartella WinLAMP."
