...
;${LangFileString} installWinLAMPTop "This will install WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}.${VERSION_MINOR_SECOND} ${InstallType}."
${LangFileString} installWinLAMPTop "This will install WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR} ${InstallType}."
...
${LangFileString} uninstallPrompt "This will uninstall WinLAMP. Continue?"
...
${LangFileString} msgCloseWinLAMP "You must close WinLAMP before you can continue.$\r$\n$\r$\n	After you have closed WinLAMP, select Retry.$\r$\n$\r$\n	If you wish to try to install anyway, select Ignore.$\r$\n$\r$\n	If you wish to abort the installation, select Abort."
${LangFileString} msgInstallAborted "Install aborted by user"

${LangFileString} secWinLAMP "WinLAMP (required)"
${LangFileString} compAgent "WinLAMP Agent"
${LangFileString} compModernSkin "Modern Skin Support"
${LangFileString} safeMode "WinLAMP (Safe Mode)"
${LangFileString} uninstallWinLAMP "Uninstall WinLAMP"
...
${LangFileString} secML "WinLAMP Media Library"
...
${LangFileString} IDS_GRP_WALIB "WinLAMP Library"
...
${LangFileString} IDS_RUN_CHECK_PROCESS "Checking if another instance of WinLAMP is running..."
...
${LangFileString} IDS_PAGE_FINISH_LINK "Click here to visit WinLAMP.com"
...
;											$\r$\n$\r$\n\
;											Features include:$\r$\n$\r$\n  \
;											•  Wirelessly sync media to the WinLAMP for Android app$\r$\n$\r$\n  \
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA) allows you to play and manage your music library, listen to Shoutcast Radio, and much more.$\r$\n$\r$\n\
											...
											•  Lots of the usually expected WinLAMP loveliness$\r$\n$\r$\n  \
											•  I am Groot!"
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"By clicking “Next”, you agree to the $(^NameDA) <a id=$\"winlamp_eula$\">License Agreement</a> and <a id=$\"winlamp_privacy_policy$\">Privacy Policy</a>."
!else
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION "Choose from the following options to configure your WinLAMP start options."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Unable to close WinLAMP Agent.$\r$\n\
												Make sure that another user is not logged into Windows.\
												$\r$\n$\r$\n	After you have closed WinLAMPAgent, select Retry.\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL "${DIRECTXINSTAL_WINLAMPNAME} requires at least ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} to operate properly.$\r$\nInstall it right now?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED "${DIRECTXINSTAL_WINLAMPNAME} requires at least ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} to operate properly"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED "Your computer is missing a ${DIRECTXINSTAL_DIRECTXNAME} component required by ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_VC_REDIST_LINK_TO_MSDOWNLOAD "WinLAMP will not run until you install the required Microsoft runtime from:"
${LangFileString} IDS_VC_ABORT "Installer will now abort."

;========================================================================================
; descriptions

${LangFileString} IDS_SEC_WINLAMP_DESC "WinLAMP core (required)"
${LangFileString} IDS_SEC_AGENT_DESC "WinLAMP Agent, for quick system tray access and maintaining filetype associations"
...
${LangFileString} IDS_SEC_HOTKEY_DESC "Global Hotkeys plugin, for controlling WinLAMP with the keyboard when other applications are in focus"
${LangFileString} IDS_SEC_TRAYCTRL_DESC "Nullsoft Tray Control plugin, for adding Play control icons in the system tray"
${LangFileString} IDS_SEC_FREEFORM_DESC "Modern Skin Support, required for using freeform skins such as WinLAMP Modern and Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC "WinLAMP Library"
${LangFileString} IDS_SEC_ML_DESC "WinLAMP Media Library (required)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC "WinLAMP Auto-Tagger (Powered by Gracenote), for filling in missing metadata"
${LangFileString} IDS_SEC_ML_WIRE_DESC "Podcast Directory, for subscribing to and downloading podcasts"
${LangFileString} IDS_SEC_ML_ONLINE_DESC "Online Services, including SHOUTcast Radio && TV, AOL Radio feat. CBS Radio, WinLAMP Charts, and more"
${LangFileString} IDS_SEC_ML_PLG_DESC "WinLAMP Playlist Generator (powered by Gracenote), for creating acoustically dynamic playlists"
...
${LangFileString} IDS_SEC_ML_FANZONE_DESC "Connect to the online WinLAMP Fanzone"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED "$\r$\n$\r$\n$\r$\nNote:  Not all files were removed from this uninstall. To view, open the WinLAMP folder."
