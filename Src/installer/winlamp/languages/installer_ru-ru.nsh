...
${LangFileString} installWinLAMPTop "Вы собираетесь установить WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}. "
${LangFileString} installerContainsFull "Программа установки содержит полную версию WinLAMP."
${LangFileString} installerContainsLite "Программа установки содержит облегченную версию WinLAMP."
...
${LangFileString} uninstallPrompt "Проигрыватель WinLAMP будет удален. Продолжить?"
...
${LangFileString} msgCloseWinLAMP "Для продолжения установки необходимо завершить работу WinLAMP.$\r$\n$\r$\nПосле закрытия WinLAMP нажмите кнопку $\"Повтор$\". Чтобы все равно продолжить установку, нажмите кнопку $\"Пропустить$\". Либо прервите установку, нажав кнопку $\"Прервать$\"."
${LangFileString} msgInstallAborted "Установка прервана пользователем"

${LangFileString} secWinLAMP "WinLAMP (обязательно)"
${LangFileString} compAgent "Агент WinLAMP"
${LangFileString} compModernSkin "Поддержка современных обложек"
${LangFileString} safeMode "WinLAMP (безопасный режим)"
${LangFileString} uninstallWinLAMP "Удалить WinLAMP"
...
${LangFileString} secML "Библиотека WinLAMP"
...
${LangFileString} IDS_GRP_WALIB				"Библиотека WinLAMP"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"Проверка на активность других экземпляров WinLAMP..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Щелкните здесь для перехода на веб-сайт WinLAMP.com"
...
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"Нажимая кнопку $\"Далее$\", вы принимаете условия <a id=$\"winlamp_eula$\">соглашения</a> и <a id=$\"winlamp_privacy_policy$\">политики конфиденциальности</a>."
!else
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Укажите, где необходимо создать ярлыки для запуска WinLAMP."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Не удалось завершить работу Агента WinLAMP.$\r$\n$\r$\n\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"Для нормальной работы ${DIRECTXINSTAL_WINLAMPNAME} требуется версия ${DIRECTXINSTAL_DIRECTXNAME} не ниже ${DIRECTXINSTALL_DIRECTXMINVER}.$\r$\n$\r$\nУстановить?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"Для нормальной работы ${DIRECTXINSTAL_WINLAMPNAME} требуется версия ${DIRECTXINSTAL_DIRECTXNAME} не ниже ${DIRECTXINSTALL_DIRECTXMINVER}"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"На компьютере не установлен компонент для ${DIRECTXINSTAL_DIRECTXNAME}, необходимый для работы ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"Ядро проигрывателя WinLAMP (обязательно)."
${LangFileString} IDS_SEC_AGENT_DESC			"В области уведомлений появится значок, с помощью которого можно получить быстрый доступ к возможностям WinLAMP."
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Позволяет управлять WinLAMP из любого активного приложения с помощью сочетаний клавиш."
${LangFileString} IDS_SEC_JUMPEX_DESC			"Позволяет организовать в WinLAMP очередь воспроизведения, а также предоставляет другие возможности."
${LangFileString} IDS_SEC_TRAYCTRL_DESC			"Позволяет управлять WinLAMP с помощью значков из области уведомлений."
${LangFileString} IDS_SEC_FREEFORM_DESC			"Требуется для поддержки современных обложек (например, WinLAMP Modern и Bento)."
...
${LangFileString} IDS_GRP_WALIB_DESC			"Библиотека WinLAMP."
${LangFileString} IDS_SEC_ML_DESC				"Библиотека WinLAMP (обязательна)."
...
${LangFileString} IDS_SEC_ML_IMPEX_DESC			"Позволяет экспортировать базу данных WinLAMP для использования в iTunes и наоборот."
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nПримечание. Удалены не все файлы. Чтобы увидеть их, откройте папку WinLAMP."
...
${LangFileString} IDS_EXPRESS_MODE_SUBHEADER "Выберите режим установки WinLAMP."
