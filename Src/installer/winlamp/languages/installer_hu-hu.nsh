...
${LangFileString} installWinLAMPTop "Jelenleg a WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType} verzióját telepíti. "
...
${LangFileString} uninstallPrompt "Biztosan szeretné eltávolítani a WinLAMPot?"
...
${LangFileString} msgCloseWinLAMP "A folytatás előtt be kell zárnia a WinLAMPot.$\r$\n$\r$\n	A WinLAMP bezárása után kattintson az Ismét gombra.$\r$\n$\r$\n	Ha a mellőzni szeretné a WinLAMP bezárását, de folytatná a telepítést, kattintson a Kihagyás gombra.$\r$\n$\r$\n	Ha szeretné megszakítani a telepítést, kattintson a Leállítás gombra."
${LangFileString} msgInstallAborted "A telepítést a felhasználó leállította"

${LangFileString} secWinLAMP "WinLAMP (kötelező)"
${LangFileString} compAgent "WinLAMP ügynök"
${LangFileString} compModernSkin "Modern téma támogatás"
${LangFileString} uninstallWinLAMP "WinLAMP eltávolítása"
...
${LangFileString} secML "WinLAMP Médiatár"
...
${LangFileString} IDS_GRP_WALIB				"WinLAMP Médiatár"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"A WinLAMP futó példányainak keresése..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Kattintson ide a WinLAMP.com meglátogatásához"
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"A $(^NameDA) segítségével zenéket, videókat, podcastokat és internetes rádiókat hallgathat, illetve nézhet.$\r$\n$\r$\n$\r$\nTovábbi lehetőségek:$\r$\n$\r$\n  \
													...
													•  Vezérelje a lejátszást a böngészőből a WinLAMP eszköztárral$\r$\n  \
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Válasszon az alábbi lehetőségek közül a WinLAMP parancsikonjainak testreszabásához."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Nem sikerült a WinLAMP ügynök bezárása.$\r$\n\
                                                   Bizonyosodjon meg róla, hogy nincs más felhasználó bejelentkezve a Windowsba.\
                                                   $\r$\n$\r$\n	Miután bezárta a WinLAMP ügynököt, kattintson az Ismét gombra.\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"A ${DIRECTXINSTAL_WINLAMPNAME} számára legalább ${DIRECTXINSTALL_DIRECTXMINVER} verziójú ${DIRECTXINSTAL_DIRECTXNAME} szükséges a megfelelő működéshez.$\r$\nSzeretné most telepíteni?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"A ${DIRECTXINSTAL_WINLAMPNAME} számára legalább ${DIRECTXINSTALL_DIRECTXMINVER} verziójú ${DIRECTXINSTAL_DIRECTXNAME} szükséges a megfelelő működéshez."
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"A számítógépéről hiányzik a ${DIRECTXINSTAL_DIRECTXNAME} összetevő, amely a ${DIRECTXINSTAL_WINLAMPNAME} számára szükséges"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"A WinLAMP fő elemei (kötelező)"
${LangFileString} IDS_SEC_AGENT_DESC			"WinLAMP ügynök, a WinLAMP gyors eléréséhez az értesítési területről és a fájltársítások karbantartásához"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Billentyűparancsok bővítmény, a WinLAMP irányítása a billentyűzettel, akkor is ha más program van fókuszban"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Modern témák támogatása, pl. a WinLAMP Modern vagy a Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC			"WinLAMP Médiatár"
${LangFileString} IDS_SEC_ML_DESC				"WinLAMP Médiatár (kötelező)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"WinLAMP Auto-címkéző (a Gracenote támogatásával), a hiányzó metaadatok kitöltéséhez"
${LangFileString} IDS_SEC_ML_WIRE_DESC			"Podcast könyvtár, a podcastokra való feliratkozáshoz és letöltésükhöz"
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Online szolgáltatások, pl. SHOUTcast rádiók és tévék, AOL rádió, benne a CBS rádió, WinLAMP toplisták, stb."
${LangFileString} IDS_SEC_ML_PLG_DESC			"WinLAMP lista generáló (a Gracenote támogatásával), akusztikusan dinamikus listák létrehozásához"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nMegjegyzés: Nem sikerült eltávolítani az összes fájlt. A fájlok megtekintéséhez nyissa meg a WinLAMP könyvtárát."
