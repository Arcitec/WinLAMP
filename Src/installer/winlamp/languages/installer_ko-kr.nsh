...
${LangFileString} installWinLAMPTop "WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}을(를) 설치합니다.  "
...
${LangFileString} uninstallPrompt "WinLAMP가 제거됩니다. 계속하시겠습니까?"
...
${LangFileString} msgCloseWinLAMP "계속하려면 WinLAMP를 닫아야 합니다.$\r$\n$\r$\n	WinLAMP를 닫은 후 $\"재시도$\"를 선택하십시오.$\r$\n$\r$\n	설치하려면 $\"무시$\"를 선택하십시오.$\r$\n$\r$\n	설치를 중단하려면 $\"중단$\"을 선택하십시오."
${LangFileString} msgInstallAborted "설치가 사용자에 의해 중단됨"

${LangFileString} secWinLAMP "WinLAMP(필수)"
${LangFileString} compAgent "WinLAMP 에이전트"
${LangFileString} compModernSkin "현대 스킨 지원"
${LangFileString} uninstallWinLAMP "WinLAMP 제거"
...
${LangFileString} secML "WinLAMP 미디어 라이브러리"
...
${LangFileString} IDS_GRP_WALIB				"WinLAMP 라이브러리"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"WinLAMP의 다른 인스턴스가 실행 중인지 확인 중..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"여기를 클릭하여 WinLAMP.com을 방문하십시오."
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"최고의 미디어 관리자 그 이상을 경험해 보세요.$\r$\n$\r$\n\
                          ...
                          새로운 음악을 발견하세요. $\r$\n  \
													...
													•  앨범 아트 지원 - WinLAMP가 찾고 사용자는 즐깁니다!$\r$\n  \
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"다음 옵션 중에서 원하는 옵션을 선택하여 WinLAMP 시작 옵션을 구성하십시오."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"WinLAMP 에이전트를 닫을 수 없습니다.$\r$\n\
                                                   다른 사용자가 Windows에 로그인되어 있지 않는지 확인하십시오.\
                                                   $\r$\n$\r$\n	WinLAMPAgent를 닫은 후 '재시도'를 선택하십시오.\
                                                   $\r$\n$\r$\n	설치하려면 '무시'를 선택하십시오.\
                                                   $\r$\n$\r$\n	설치를 중단하려면 '중단'을 선택하십시오."
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"WinLAMP 코어(필수)"
${LangFileString} IDS_SEC_AGENT_DESC			"WinLAMP 에이전트(시스템 트레이에 빠르게 액세스하고 파일 형식 연결 유지)"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"글로벌 핫키 플러그인(다른 응용프로그램이 활성 상태일 때 키보드로 WinLAMP 제어)"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"현대 스킨 지원(WinLAMP Modern 및 Bento와 같은 자유형 스킨 사용 시 필요)"
...
${LangFileString} IDS_GRP_WALIB_DESC			"WinLAMP 라이브러리"
${LangFileString} IDS_SEC_ML_DESC				"WinLAMP 미디어 라이브러리(필수)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"Gracenote에 의해 성능이 강화된 WinLAMP Auto-Tagger(누락된 메타데이터 입력)"
...
${LangFileString} IDS_SEC_ML_PLG_DESC			"Gracenote에 의해 성능 강화된 WinLAMP 재생목록 생성기(음향적으로 동적 재생목록 작성)"
