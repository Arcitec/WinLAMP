; WinLAMP Installer Translation file.
;
...
; Email:		paul@winlampnederlands.nl
; Community:		www.winlampnederlands.nl
;
; History:
...
;
; 22.03.08	* Added IDS_BUNDLE21_NAME, _DESCRIPTION & IDS_WINLAMP_SEARCH strings
;		* Added suffix 360 to Xbox
;		* Various small changes
;
; 26.03.08	* Edited IDS_WINLAMP_SEARCH; removed Google®
;
...
${LangFileString} installWinLAMPTop 	"Hiermee installeert u WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}.  "
...
${LangFileString} uninstallPrompt 	"Hierdoor wordt WinLAMP gedeïnstalleerd. Doorgaan?"
...
${LangFileString} msgCloseWinLAMP 	"Voordat u verder kunt, moet u eerst WinLAMP afsluiten.$\r$\n$\r$\n	Nadat u WinLAMP hebt afgesloten, selecteert u Opnieuw.$\r$\n$\r$\n	Als u de installatie wilt voortzetten zonder WinLAMP af te sluiten, selecteert u Negeren.$\r$\n$\r$\n	Als u de installatie wilt annuleren, selecteert u Afbreken."
${LangFileString} msgInstallAborted 	"Installatie afgebroken door gebruiker"

${LangFileString} secWinLAMP 		"WinLAMP (vereist)"
${LangFileString} compAgent 		"WinLAMP Agent"
${LangFileString} compModernSkin 	"Ondersteuning voor Moderne Skins"
${LangFileString} uninstallWinLAMP 	"WinLAMP Verwijderen"
...
${LangFileString} secML 		"WinLAMP Mediabibliotheek"
...
${LangFileString} IDS_GRP_WALIB			"WinLAMP Bibliotheek"
...
${LangFileString} IDS_RUN_CHECK_PROCESS				"Controleert of er een andere sessie van WinLAMP actief is..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"Klik hier om WinLAMP.com te bezoeken"
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"Bereid u voor op de ultieme mediamanager, en nog veel meer.$\r$\n$\r$\n\
							...
							•  Ondersteuning voor albumhoezen die WinLAMP heeft gevonden!$\r$\n  \
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Configureer de startopties van WinLAMP met de volgende opties."
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"Kan WinLAMP Agent niet sluiten.$\r$\n\
                                                   Zorg dat er geen andere gebruikers bij Windows zijn aangemeld.\
                                                   $\r$\n$\r$\n	Selecteer Opnieuw nadat u WinLAMPAgent hebt afgesloten.\
...
${LangFileString} IDS_DIRECTX_FULL_INSTALL_APPROVAL		"${DIRECTXINSTAL_WINLAMPNAME} vereist minimaal ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} om te kunnen draaien.$\r$\nWilt u het nu installeren?"
${LangFileString} IDS_DIRECTX_FULL_CONNECT_FAILED		"${DIRECTXINSTAL_WINLAMPNAME} veresit minumaal ${DIRECTXINSTAL_DIRECTXNAME} ${DIRECTXINSTALL_DIRECTXMINVER} om te kunnen draaien"
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"Uw computer mist een ${DIRECTXINSTAL_DIRECTXNAME} component vereist voor ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"Kerncomponenten van WinLAMP (vereist)"
${LangFileString} IDS_SEC_AGENT_DESC			"WinLAMP Agent, voor handig systeemvakicoon en beheer van bestandskoppelingen"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"Plug-in voor globale sneltoetsen, voor toetsenbordbediening van WinLAMP als andere toepassingen de actieve toepassing zijn"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Ondersteuning voor moderne skins, vereist voor skins met een vrije vorm, zoals WinLAMP Modern en Bento"
...
${LangFileString} IDS_GRP_WALIB_DESC			"WinLAMP Bibliotheek"
${LangFileString} IDS_SEC_ML_DESC			"WinLAMP Mediabibliotheek (vereist)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"WinLAMP Auto-Tagger (aangeboden door Gracenote), voor het invullen van ontbrekende metagegevens"
...
${LangFileString} IDS_SEC_ML_PLG_DESC			"WinLAMP Speellijstgenerator (aangeboden door Gracenote), voor het opstellen van akoestisch dynamische speellijsten"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nNB: Niet alle bestanden zijn verwijderd. Om deze te bekijken opent u de WinLAMP-map."