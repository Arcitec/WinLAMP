...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"Veuillez sélectionner, parmi les possibilités suivantes, les différents raccourcis vers WinLAMP à créer."
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"Support des skins modernes, requis pour l'utilisation des skins avancés comme WinLAMP Modern et WinLAMP Bento"
