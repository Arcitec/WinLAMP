...
${LangFileString} installWinLAMPTop "WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType} をインストールします。"
...
${LangFileString} licenseTop "WinLAMPをインストールする前に、ライセンス条件を確認してください。"
${LangFileString} directoryTop "インストーラによって $(^NameDA) に最適な場所が決定されました。フォルダを変更する場合は、ここで変更してください。"

${LangFileString} uninstallPrompt "この操作は WinLAMP をアンインストールします。続けますか？"
...
${LangFileString} msgCloseWinLAMP "操作を続行するには WinLAMP を閉じる必要があります。$\r$\n$\r$\n	WinLAMP を閉じたあと、[再試行]をクリックしてください。$\r$\n$\r$\n	インストール作業を強行するなら、[無視]をクリックしてください。$\r$\n$\r$\n	インストール作業を中止するなら、[中止]をクリックしてください。"
${LangFileString} msgInstallAborted "インストールはユーザによって中止されました"

${LangFileString} secWinLAMP "WinLAMP (必須)"
${LangFileString} compAgent "WinLAMP エージェント"
${LangFileString} compModernSkin "モダン スキン サポート"
${LangFileString} safeMode "WinLAMP (セーフモード)"
${LangFileString} uninstallWinLAMP "WinLAMP のアンインストール"
...
${LangFileString} secML "WinLAMP メディア ライブラリ"
...
${LangFileString} IDS_GRP_WALIB				"WinLAMPライブラリ"
...
${LangFileString} IDS_RUN_CHECK_PROCESS			"WinLAMP の別のインスタンスが実行しているか確認しています..."
...
${LangFileString} IDS_PAGE_FINISH_LINK		"ここをクリックすると WinLAMP.com に接続します"
...
${LangFileString} IDS_PAGE_WELCOME_TEXT		"$(^NameDA) はメディアライブラリを管理し、インターネットラジオを聴くことができます。 \
											WinLAMP クラウドを使用すれば、車の中、職場、家庭、任意の場所で聞くことができます。$\r$\n$\r$\n\
											含まれる機能:$\r$\n$\r$\n  \
												•  WinLAMP クラウドで手持ちの音楽ライブラリを便利に活用$\r$\n$\r$\n  \
												•  すべてのデバイス間で音楽ライブラリ全体を管理$\r$\n$\r$\n  \
												•  Android版WinLAMPとワイヤレス同期$\r$\n$\r$\n  \
													・自動プレイリストジェネレータを使ってプレイリストを作成$\r$\n$\r$\n  \
													・3万以上のポッドキャスト"
											
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"「次へ」をクリックして $(^NameDA) の<a id=$\"winlamp_eula$\">使用権許諾契約</a>と<a id=$\"winlamp_privacy_policy$\">プライバシーポリシー</a>に同意して下さい。"
!else
...
${LangFileString} IDS_PAGE_STARTMENU_CAPTION		"以下のオプションから選択して WinLAMP スタートオプションを設定してください。"
...
; messages
${LangFileString} IDS_MSG_AGENTONOTHERSESSION	"WinLAMP エージェント を閉じることができません。$\r$\n\
                                                   別のユーザが Windows にログインしていないか確認してください。\
                                                   $\r$\n$\r$\n	WinLAMP エージェント を閉じた後に[再試行]を選択してください。\
...
${LangFileString} IDS_DIRECTX_EMBED_CONNECT_FAILED		"Your computer missing ${DIRECTXINSTAL_DIRECTXNAME} component required by ${DIRECTXINSTAL_WINLAMPNAME}"
...
${LangFileString} IDS_SEC_WINLAMP_DESC			"WinLAMP コア (必須)"
${LangFileString} IDS_SEC_AGENT_DESC			"WinLAMP エージェント。素早いシステムトレイへのアクセスとファイルタイプ関連付けの維持を行います。"
...
${LangFileString} IDS_SEC_HOTKEY_DESC			"グローバルホットキープラグイン。他のアプリケーションにフォーカスがあるときに WinLAMP をキーボードでコントロールします。"
...
${LangFileString} IDS_SEC_FREEFORM_DESC			"モダンスキンサポート。 WinLAMP Moderun および Bento 等のフリーフォームスキンを使用するときに必要です。"
...
${LangFileString} IDS_GRP_WALIB_DESC			"WinLAMP ライブラリ"
${LangFileString} IDS_SEC_ML_DESC				"WinLAMP メディアライブラリ (必須)"
...
${LangFileString} IDS_SEC_ML_AUTOTAG_DESC		"WinLAMP 自動タグ付け。(Powered by Gracenote) 欠落したメタデータの穴埋めをします。"
${LangFileString} IDS_SEC_ML_WIRE_DESC			"ポッドキャスト ディレクトリ。ポッドキャストの申し込み、およびダウンロード用です。"
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"オンラインサービス。SHOUTcastラジオおよび、TV、AOLラジオ、CBS Radio, WinLAMPチャートとその他を含みます。"
${LangFileString} IDS_SEC_ML_PLG_DESC			"WinLAMP プレイリスト生成。 (powered by Gracenote) 音響的な観点から動的にプレイリストを作成します。"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\n補足:  このアンインストールでは全てのファイルが削除されませんでした。確認するには WinLAMP フォルダを開いてください。"
