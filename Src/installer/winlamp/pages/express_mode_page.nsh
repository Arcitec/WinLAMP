!ifndef NULLSOFT_WINLAMP_INSTALLER_EXPRESS_MODE_PAGE_HEADER
!define NULLSOFT_WINLAMP_INSTALLER_EXPRESS_MODE_PAGE_HEADER
...
!endif ; defined(NULLSOFT_WINLAMP_INSTALLER_EXPRESS_MODE_PAGE_HEADER)