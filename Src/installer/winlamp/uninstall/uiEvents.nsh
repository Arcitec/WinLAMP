!ifndef NULLSOFT_WINLAMP_UNINSTALLER_UI_EVENTS_HEADER
!define NULLSOFT_WINLAMP_UNINSTALLER_UI_EVENTS_HEADER
...
Function un.UI_OnFinishPageReadMe
	...
	${Else}
		StrCpy $0 "Unknown"
	${Endif}
	ExecShell "open" '"http://services.winlamp.com/redirect/support?reason=uninstall&subject=WinLAMP Uninstall&product=WinLAMP Desktop&v=${VERSION_MAJOR}.${VERSION_MINOR}${VERSION_MINOR_SECOND} ${InstallType}&platform=Windows $0"'
FunctionEnd
...
Function un.UI_OnFinishPageShow
	...
	StrCpy $0 ""
	${If} $winlamp.uninstall.checkFolder == "true"
		${DirState} "$INSTDIR" $0
		${If} $0 == 1
...
!endif ; NULLSOFT_WINLAMP_UNINSTALLER_UI_EVENTS_HEADER