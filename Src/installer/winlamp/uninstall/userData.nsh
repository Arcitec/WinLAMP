!ifndef NULLSOFT_WINLAMP_UNINSTALLER_USERDATA_HEADER
!define NULLSOFT_WINLAMP_UNINSTALLER_USERDATA_HEADER
...
Section "un.$(IDS_UNINSTALL_USER_PREFERENCES)" IDX_UNINSTALL_USER_PREFERENCES
	...
	Delete "$SETTINGSDIR\WinLAMP.ini"
	Delete "$SETTINGSDIR\WinLAMP.lks"
	Delete "$SETTINGSDIR\winlamp.m3u"
	Delete "$SETTINGSDIR\winlamp.m3u8"
	Delete "$SETTINGSDIR\winlamp.log"
	Delete "$APPDATA\WinLAMP\winlamp.log"
	Delete "$SETTINGSDIR\winlamp.pic"
	Delete "$SETTINGSDIR\studio.xnf"
	Delete "$SETTINGSDIR\WinLAMP.q1"
	Delete "$SETTINGSDIR\WinLAMP.q2"
	Delete "$SETTINGSDIR\WinLAMP.bm"
	Delete "$SETTINGSDIR\WinLAMP.bm8"
	...
	RMDir /r "$SETTINGSDIR"
SectionEnd
!endif ; NULLSOFT_WINLAMP_UNINSTALLER_USERDATA_HEADER