!ifndef NULLSOFT_WINLAMP_INSTALLER_EXPRESS_MODE_HEADER
!define NULLSOFT_WINLAMP_INSTALLER_EXPRESS_MODE_HEADER
...
!endif ; defined(NULLSOFT_WINLAMP_INSTALLER_EXPRESS_MODE_HEADER)