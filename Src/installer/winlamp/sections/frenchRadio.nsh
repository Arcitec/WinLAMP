!ifndef NULLSOFT_WINLAMP_INSALLER_FRENCHRADIO_HEADER
!define NULLSOFT_WINLAMP_INSALLER_FRENCHRADIO_HEADER
...
!ifdef FULL
	...
	!macro FrenchRadio_InsertInstallSections
		...
		${WinLAMPSection} "FrenchRadio" $(IDS_SEC_GEN_FRENCHRADIO)  IDX_SEC_GEN_FRENCHRADIO  ; >>> [French Radio plugin]
			...
			SetDetailsPrint lastused
		${WinLAMPSectionEnd}                                                  			; <<< [French Radio plugin]
...
!endif ;NULLSOFT_WINLAMP_INSALLER_FRENCHRADIO_HEADER