...
!ifdef WALANG_SHOWSECTIONS
	${WinLAMPSection} "language${NSIS_LANGID}" "${LANGFILE_${NSIS_LANGID}_NAME}" IDX_SEC_${LANGID}
		${SECTIONIN_STD}
!else
	${WinLAMPSection} "language${NSIS_LANGID}" "-${LANGFILE_${NSIS_LANGID}_NAME}" IDX_SEC_${LANGID}
...
!if 1
		File "..\..\resources\languages\WinLAMP-${LANGID}.wlz"
		${If} '${LANG_${NSIS_LANGID}}' == $LANGUAGE
			WriteINIStr "$WINLAMPINI" "WinLAMP" "langpack" "WinLAMP-${LANGID}.wlz"
		${EndIf}
!else
		File /r "..\..\resources\languages\WinLAMP-${LANGID}"
		${If} '${LANG_${NSIS_LANGID}}' == $LANGUAGE
			WriteINIStr "$WINLAMPINI" "WinLAMP" "langpack" "WinLAMP-${LANGID}"
		${EndIf}
!endif
	${WinLAMPSectionEnd}
!endif
...
!ifdef WALANG_SHOWSECTIONS
	${WinLAMPSection} "languageEnglish" "${LANGFILE_ENGLISH_NAME}" IDX_SEC_EN-US
!else
	${WinLAMPSection} "languageEnglish" "-${LANGFILE_ENGLISH_NAME}" IDX_SEC_EN-US
!endif ; WALANG_SHOWSECTIONS
		SectionIn 1 2 3 4 5 6 7 8 RO
		ReadINIStr $LANG_DIR "$WINLAMPINI" "WinLAMP" "LangDir"
		${If} $LANG_DIR == ""
		...
		${If} '1033' == $LANGUAGE
			DeleteINIStr "$WINLAMPINI" "WinLAMP" "langpack"
		${EndIf}
	${WinLAMPSectionEnd} ; IDX_SEC_EN-US
