...
!if 0
!ifndef WINLAMP64
	${WinLAMPSection} "visTiny" $(secTiny) IDX_SEC_NSFS        ; >>> [Nullsoft Tiny Fullscreen]
		${SECTIONIN_LITE}
		Call SetVisPluginDir
		File ${FILES_PATH}\Plugins\vis_nsfs.dll
	${WinLAMPSectionEnd}                                       ; <<< [Nullsoft Tiny Fullscreen]
!endif ; WINLAMP64
!endif

!ifdef full
!ifndef WINLAMP64
	${WinLAMPSection} "visAVS" $(secAVS) IDX_SEC_AVS          ; >>> [Advanced Visualization Studio]
		${SECTIONIN_FULL}
		Call SetVisPluginDir
	...
	${WinLAMPSectionEnd}                                   ; <<< [Advanced Visualization Studio]
!endif ; WINLAMP64
!endif ; full

!ifdef std | full
!ifndef WINLAMP64
	${WinLAMPSection} "secMilk2" $(IDS_SEC_MILKDROP2) IDX_SEC_MILKDROP2      ; >>> [Milkdrop2]
		${SECTIONIN_STD}
		Call SetVisPluginDir
		...
		ClearErrors
		ReadINIStr $0 "$WINLAMPINI" "WinLAMP" "visplugin_name"
		IfErrors 0 +3
		WriteINIStr "$WINLAMPINI" "WinLAMP" "visplugin_name" vis_milk2.dll
		WriteINIStr "$WINLAMPINI" "WinLAMP" "visplugin_num" 0
		SetOutPath $INSTDIR\Plugins
	${WinLAMPSectionEnd}                                                  ; <<< [Milkdrop2]
!endif ; WINLAMP64
!endif ; full

!ifdef full
!ifndef WINLAMP64
	${WinLAMPSection} "visLine" $(secLineInput) IDX_SEL_LINEIN           ; >>> [Line Input Support]
		${SECTIONIN_FULL}
		SetOutPath $INSTDIR\Plugins
		File "${FILES_PATH}\Plugins\in_linein.dll"
	${WinLAMPSectionEnd}                                                  ; <<< [Line Input Support]
!endif ; WINLAMP64
!endif ; std | full
