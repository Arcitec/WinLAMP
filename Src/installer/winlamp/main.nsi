...
; temp hack 2022 (hard-coded to 32-bit release build - might need e.g. a WinLAMP_x64_Release version later)
!ifndef FILES_PATH
	!define FILES_PATH ..\..\..\Build\WinLAMP_x86_Release
; change to this when copied to WinLAMP-Desktop\Src\Build\WinLAMP_x86_Release\installer\winlamp
;	!define FILES_PATH ..\..\..\WinLAMP_x86_Release
!endif

!define MUI_LANGDLL_REGISTRY_ROOT HKLM
!define MUI_LANGDLL_REGISTRY_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\${WINLAMP}"
...
!ifndef _DEBUG
;	BrandingText "WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR}.${VERSION_MINOR_SECOND} ${InstallType} -- $(BuiltOn) ${__DATE__} $(at) ${__TIME__}"
	BrandingText "WinLAMP ${VERSION_MAJOR}.${VERSION_MINOR} ${InstallType} -- $(BuiltOn) ${__DATE__} $(at) ${__TIME__}"
!else
	BrandingText "WinLAMP Debug -- internal use only"
!endif

RequestExecutionLevel admin
Caption $(IDS_CAPTION)
Name "${WINLAMP}"
InstallDir "$PROGRAMFILES\${WINLAMPFOLDER}"
...
!ifndef INSTALL_NAME
	!define INSTALL_NAME "winlamp${VERSION_MAJOR}${VERSION_MINOR}${VERSION_MINOR_SECOND}"
!endif
...
!else
	...
	!else
		OutFile 'winlamp_unknown${LANG_FILESPEC}.exe'
	!endif
!endif
...
Function .onInit
	...
	StrCpy $INSTDIR "$0\${WINLAMPFOLDER}"
	!endif
...
Function un.onInit
	...
	StrCpy $winlamp.uninstall.checkFolder "false"
FunctionEnd
