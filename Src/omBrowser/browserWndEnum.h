#ifndef NULLSOFT_WINLAMP_OMBROWSER_WINDOW_ENUMERATOR_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_WINDOW_ENUMERATOR_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_WINDOW_ENUMERATOR_HEADER