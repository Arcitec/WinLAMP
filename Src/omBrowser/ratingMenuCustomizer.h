#ifndef NULLSOFT_WINLAMP_RATING_MENU_CUSTOMIZER_HEADER
#define NULLSOFT_WINLAMP_RATING_MENU_CUSTOMIZER_HEADER
...
#endif //NULLSOFT_WINLAMP_RATING_MENU_CUSTOMIZER_HEADER