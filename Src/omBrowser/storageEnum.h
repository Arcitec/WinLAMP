#ifndef NULLSOFT_WINLAMP_OMSTORAGE_ENUMERATOR_HEADER
#define NULLSOFT_WINLAMP_OMSTORAGE_ENUMERATOR_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSTORAGE_ENUMERATOR_HEADER