#ifndef NULLSOFT_WINLAMP_OMCACHE_RECORD_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMCACHE_RECORD_INTERFACE_HEADER
...
#endif //NULLSOFT_WINLAMP_OMCACHE_RECORD_INTERFACE_HEADER