#ifndef NULLSOFT_WINLAMP_MENU_CUSTOMIZER_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_MENU_CUSTOMIZER_INTERFACE_HEADER
...
#endif // NULLSOFT_WINLAMP_MENU_CUSTOMIZER_INTERFACE_HEADER