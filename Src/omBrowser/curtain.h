#ifndef NULLSOFT_WINLAMP_OMBROWSER_CURTAIN_CONTROL_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_CURTAIN_CONTROL_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_CURTAIN_CONTROL_HEADER