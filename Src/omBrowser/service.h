#ifndef NULLSOFT_WINLAMP_OMSERVICE_IMPLEMENTATION_HEADER
#define NULLSOFT_WINLAMP_OMSERVICE_IMPLEMENTATION_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSERVICE_IMPLEMENTATION_HEADER