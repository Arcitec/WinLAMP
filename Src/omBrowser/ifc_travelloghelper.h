#ifndef NULLSOFT_WINLAMP_OMBROWSER_TRAVELLOG_HELPER_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_TRAVELLOG_HELPER_INTERFACE_HEADER
...
#endif // NULLSOFT_WINLAMP_OMBROWSER_TRAVELLOG_HELPER_INTERFACE_HEADER