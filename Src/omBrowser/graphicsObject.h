#ifndef NULLSOFT_WINLAMP_UTILITY_GRAPHICS_OBJECT_HEADER
#define NULLSOFT_WINLAMP_UTILITY_GRAPHICS_OBJECT_HEADER
...
#endif // NULLSOFT_WINLAMP_UTILITY_GRAPHICS_OBJECT_HEADER