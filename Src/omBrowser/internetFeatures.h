#ifndef NULLSOFT_WINLAMP_INTERNET_FEATURES_HELPER_HEADER
#define NULLSOFT_WINLAMP_INTERNET_FEATURES_HELPER_HEADER
...
#endif NULLSOFT_WINLAMP_INTERNET_FEATURES_HELPER_HEADER