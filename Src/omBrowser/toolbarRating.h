#ifndef NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_RATING_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_RATING_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_RATING_HEADER
