#ifndef NULLSOFT_WINLAMP_SKINNED_MENU_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_SKINNED_MENU_INTERFACE_HEADER
...
#endif // NULLSOFT_WINLAMP_SKINNED_MENU_INTERFACE_HEADER
