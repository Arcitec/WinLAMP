#ifndef NULLSOFT_WINLAMP_SKINNED_RATING_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_SKINNED_RATING_INTERFACE_HEADER
...
#endif // NULLSOFT_WINLAMP_SKINNED_RATING_INTERFACE_HEADER
