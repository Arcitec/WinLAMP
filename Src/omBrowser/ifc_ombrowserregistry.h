#ifndef NULLSOFT_WINLAMP_OMBROWSER_REGISTRY_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_REGISTRY_INTERFACE_HEADER
...
#endif // NULLSOFT_WINLAMP_OMBROWSER_CONFIG_INTERFACE_HEADER