#ifndef NULLSOFT_WINLAMP_OMGRAPHICS_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMGRAPHICS_INTERFACE_HEADER
...
#endif //NULLSOFT_WINLAMP_OMGRAPHICS_INTERFACE_HEADER