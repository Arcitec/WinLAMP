#ifndef NULLSOFT_WINLAMP_OMSTORAGE_ASYNC_ENUMERATOR_WRAPPER_HEADER
#define NULLSOFT_WINLAMP_OMSTORAGE_ASYNC_ENUMERATOR_WRAPPER_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSTORAGE_ASYNC_ENUMERATOR_WRAPPER_HEADER