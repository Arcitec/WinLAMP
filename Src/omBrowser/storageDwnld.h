#ifndef NULLSOFT_WINLAMP_OMSTORAGE_DOWNLOADER_HEADER
#define NULLSOFT_WINLAMP_OMSTORAGE_DOWNLOADER_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSTORAGE_DOWNLOADER_HEADER