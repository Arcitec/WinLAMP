#ifndef NULLSOFT_WINLAMP_ENUMERATOR_XML_BUFFER_HEADER
#define NULLSOFT_WINLAMP_ENUMERATOR_XML_BUFFER_HEADER
...
#endif //NULLSOFT_WINLAMP_ENUMERATOR_XML_BUFFER_HEADER