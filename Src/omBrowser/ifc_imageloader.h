#ifndef NULLSOFT_WINLAMP_OMIMAGELOADER_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMIMAGELOADER_INTERFACE_HEADER
...
#endif //NULLSOFT_WINLAMP_OMIMAGELOADER_INTERFACE_HEADER