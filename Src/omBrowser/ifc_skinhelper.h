#ifndef NULLSOFT_WINLAMP_SKIN_HELPER_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_SKIN_HELPER_INTERFACE_HEADER
...
#endif // NULLSOFT_WINLAMP_SKIN_HELPER_INTERFACE_HEADER
