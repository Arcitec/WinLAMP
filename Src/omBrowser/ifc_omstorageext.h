#ifndef NULLSOFT_WINLAMP_OMSTORAGE_EXTENDER_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMSTORAGE_EXTENDER_INTERFACE_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSTORAGE_EXTENDER_INTERFACE_HEADER