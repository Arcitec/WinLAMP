#ifndef NULLSOFT_WINLAMP_OMBROWSER_RATING_MENU_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_RATING_MENU_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_RATING_MENU_HEADER