#ifndef NULLSOFT_WINLAMP_OMBROWSER_OPTIONS_HOOK_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_OPTIONS_HOOK_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_OPTIONS_HOOK_HEADER