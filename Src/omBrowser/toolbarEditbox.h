#ifndef NULLSOFT_WINLAMP_OMBROWSER_TOOLBAREDITBOX_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_TOOLBAREDITBOX_HEADER
...
#endif // NULLSOFT_WINLAMP_OMBROWSER_TOOLBAREDITBOX_HEADER