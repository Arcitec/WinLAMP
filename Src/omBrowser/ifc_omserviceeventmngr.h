#ifndef NULLSOFT_WINLAMP_OMSERVICE_EVENTMANAGER_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMSERVICE_EVENTMANAGER_INTERFACE_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSERVICE_EVENTMANAGER_INTERFACE_HEADER