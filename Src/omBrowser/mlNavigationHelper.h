#ifndef NULLSOFT_WINLAMP_ML_NAVIGATION_HELPER_HEADER
#define NULLSOFT_WINLAMP_ML_NAVIGATION_HELPER_HEADER
...
#endif //NULLSOFT_WINLAMP_ML_NAVIGATION_HELPER_HEADER