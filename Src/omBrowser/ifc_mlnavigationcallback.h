#ifndef NULLSOFT_WINLAMP_ML_NAVIGATION_CALLBACK_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_ML_NAVIGATION_CALLBACK_INTERFACE_HEADER
...
#endif // NULLSOFT_WINLAMP_ML_NAVIGATION_CALLBACK_INTERFACE_HEADER