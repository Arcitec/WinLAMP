#ifndef NULLSOFT_WINLAMP_OMCACHE_GROUP_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMCACHE_GROUP_INTERFACE_HEADER
...
#endif //NULLSOFT_WINLAMP_OMCACHE_GROUP_INTERFACE_HEADER