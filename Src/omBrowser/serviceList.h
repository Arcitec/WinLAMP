#ifndef NULLSOFT_WINLAMP_OMSERVICE_LIST_ENUMERATOR_HEADER
#define NULLSOFT_WINLAMP_OMSERVICE_LIST_ENUMERATOR_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSERVICE_LIST_ENUMERATOR_HEADER