#ifndef NULLSOFT_WINLAMP_OMBROWSER_WINDOW_RECORD_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_WINDOW_RECORD_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_WINDOW_RECORD_HEADER