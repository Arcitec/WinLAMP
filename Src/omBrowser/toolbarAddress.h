#ifndef NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_ADDRESS_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_ADDRESS_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_STATIC_HEADER