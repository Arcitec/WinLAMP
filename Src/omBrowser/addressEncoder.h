#ifndef NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_ADDRESS_DECODER_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_ADDRESS_DECODER_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_ADDRESS_DECODER_HEADER