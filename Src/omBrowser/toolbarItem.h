#ifndef NULLSOFT_WINLAMP_OMBROWSER_TOOLBARITEM_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_TOOLBARITEM_HEADER
...
#endif // NULLSOFT_WINLAMP_OMBROWSER_TOOLBARITEM_HEADER