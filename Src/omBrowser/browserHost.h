#ifndef NULLSOFT_WINLAMP_OMBROWSER_BROWSERHOST_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_BROWSERHOST_HEADER
...
#endif // NULLSOFT_WINLAMP_OMBROWSER_BROWSERHOST_HEADER
