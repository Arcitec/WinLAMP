#ifndef NULLSOFT_WINLAMP_OMSTORAGETYPE_WEB_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMSTORAGETYPE_WEB_INTERFACE_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSTORAGETYPE_WEB_INTERFACE_HEADER