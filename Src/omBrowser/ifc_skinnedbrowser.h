#ifndef NULLSOFT_WINLAMP_OMBROWSER_SKINNED_BROWSER_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_SKINNED_BROWSER_INTERFACE_HEADER
...
#endif // NULLSOFT_WINLAMP_OMBROWSER_SKINNED_BROWSER_INTERFACE_HEADER
