#ifndef NULLSOFT_WINLAMP_OMSTORAGETYPE_FILE_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMSTORAGETYPE_FILE_INTERFACE_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSTORAGETYPE_FILE_INTERFACE_HEADER