#ifndef NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_BUTTON_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_BUTTON_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_BUTTON_HEADER
