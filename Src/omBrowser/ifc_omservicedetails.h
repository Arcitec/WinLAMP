#ifndef NULLSOFT_WINLAMP_OMSERVICE_DETAILS_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMSERVICE_DETAILS_INTERFACE_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSERVICE_DETAILS_INTERFACE_HEADER