#ifndef NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_PROGRESS_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_PROGRESS_HEADER
...
#endif //NULLSOFT_WINLAMP_OMBROWSER_TOOLBAR_PROGRESS_HEADER
