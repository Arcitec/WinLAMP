...
var errorDescriptionUnknown = "WinLAMP has received an unknown error from the Online Service.";
...
var errorDescription403 = "WinLAMP was able to connect to the server for this Online Service, however the service has returned an error indicating that you do not have access to the page.  This may be caused by a problem with the webserver configuration or other problem with the Online Service.";
var errorTitle404 = "The page cannot be found";
var errorCode404 = "HTTP 404 - File Not Found";
var errorDescription404 = "WinLAMP was able to connect to the server for this Online Service, however the service has returned an error indicating that the page requested can not be found.  This may be caused by a broken link, or other problem with the Online Service.";
...
var errorDescription408 = "WinLAMP did not send a request issued by the Online Service within the length of time that the Online Service would wait for the request.";
...
var errorDescription505 = "WinLAMP has made a request to the Online Service in an HTTP version not supported by the Online Service.  This is either a server configuration problem with the Online Service, or you may need to change your browser's HTTP protocol settings.";
