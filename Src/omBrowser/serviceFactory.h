#ifndef NULLSOFT_WINLAMP_OMSERVICEOBJECT_FACTORY_HEADER
#define NULLSOFT_WINLAMP_OMSERVICEOBJECT_FACTORY_HEADER
...
#endif //NULLSOFT_WINLAMP_OMSERVICEOBJECT_FACTORY_HEADER