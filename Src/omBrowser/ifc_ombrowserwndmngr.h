#ifndef NULLSOFT_WINLAMP_OMBROWSER_WINDOW_MANAGER_INTERFACE_HEADER
#define NULLSOFT_WINLAMP_OMBROWSER_WINDOW_MANAGER_INTERFACE_HEADER
...
#endif // NULLSOFT_WINLAMP_OMBROWSER_WINDOW_MANAGER_INTERFACE_HEADER