#ifndef _NULLSOFT_WINLAMP_DEVICES_DEVICE_OBJECT_STORE_HEADER
#define _NULLSOFT_WINLAMP_DEVICES_DEVICE_OBJECT_STORE_HEADER
...
#endif // _NULLSOFT_WINLAMP_DEVICES_DEVICE_OBJECT_STORE_HEADER