#ifndef _NULLSOFT_WINLAMP_DEVICES_DEVICE_OBJECT_INTERFACE_HEADER
#define _NULLSOFT_WINLAMP_DEVICES_DEVICE_OBJECT_INTERFACE_HEADER
...
#endif //_NULLSOFT_WINLAMP_DEVICES_DEVICE_OBJECT_INTERFACE_HEADER