#ifndef _NULLSOFT_WINLAMP_DEVICES_DEVICE_COMMAND_HEADER
#define _NULLSOFT_WINLAMP_DEVICES_DEVICE_COMMAND_HEADER
...
#endif // _NULLSOFT_WINLAMP_DEVICES_DEVICE_COMMAND_HEADER
