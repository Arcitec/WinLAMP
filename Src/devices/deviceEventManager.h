#ifndef _NULLSOFT_WINLAMP_DEVICES_DEVICE_EVENT_MANAGER_HEADER
#define _NULLSOFT_WINLAMP_DEVICES_DEVICE_EVENT_MANAGER_HEADER
...
#endif // _NULLSOFT_WINLAMP_DEVICES_DEVICE_EVENT_MANAGER_HEADER