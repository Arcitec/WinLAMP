#ifndef _NULLSOFT_WINLAMP_DEVICES_DEVICE_CONNECTION_HEADER
#define _NULLSOFT_WINLAMP_DEVICES_DEVICE_CONNECTION_HEADER
...
#endif // _NULLSOFT_WINLAMP_DEVICES_DEVICE_CONNECTION_HEADER
