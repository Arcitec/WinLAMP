#ifndef _NULLSOFT_WINLAMP_DEVICES_DEVICE_OBJECT_ENUMERATOR_HEADER
#define _NULLSOFT_WINLAMP_DEVICES_DEVICE_OBJECT_ENUMERATOR_HEADER
...
#endif // _NULLSOFT_WINLAMP_DEVICES_DEVICE_OBJECT_ENUMERATOR_HEADER