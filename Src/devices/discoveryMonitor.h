#ifndef _NULLSOFT_WINLAMP_DEVICES_DISCOVERY_MONITOR_HEADER
#define _NULLSOFT_WINLAMP_DEVICES_DISCOVERY_MONITOR_HEADER
...
#endif // _NULLSOFT_WINLAMP_DEVICES_DISCOVERY_MONITOR_HEADER