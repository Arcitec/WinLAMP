#ifndef _NULLSOFT_WINLAMP_DEVICES_DEVICE_TYPE_HEADER
#define _NULLSOFT_WINLAMP_DEVICES_DEVICE_TYPE_HEADER
...
#endif // _NULLSOFT_WINLAMP_DEVICES_DEVICE_TYPE_HEADER
