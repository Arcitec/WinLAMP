#ifndef NULLSOFT_WINLAMP_SETUP_SERVICE_HEADER
#define NULLSOFT_WINLAMP_SETUP_SERVICE_HEADER
...
public:
	...
	HRESULT Start(HWND hwndWinLAMP);
	...
	HRESULT GetWinLAMPWnd(HWND *phwndWinLAMP); // this call will return S_OK only after setup->Start()
...
inline HRESULT svc_setup::Start(HWND hwndWinLAMP)
{
	return _call(API_SETUP_START, E_NOTIMPL, hwndWinLAMP);
}
...
inline HRESULT svc_setup::GetWinLAMPWnd(HWND *phwndWinLAMP)
{
	return _call(API_SETUP_GETWINLAMPWND, E_NOTIMPL, phwndWinLAMP);
}
...
#endif //NULLSOFT_WINLAMP_SETUP_SERVICE_HEADER
