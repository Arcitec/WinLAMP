...
HWND Browser::CreateHWND()
{
	...
	EnableMenuItem(main_menu, WINLAMP_BROWSER_ID, MF_BYCOMMAND | MF_ENABLED);
...
{
	MENUITEMINFO i = {sizeof(i), MIIM_STATE , MFT_STRING, config_si_open ? MFS_CHECKED : MFS_UNCHECKED, WINLAMP_BROWSER_ID};
	SetMenuItemInfo(main_menu, WINLAMP_BROWSER_ID, FALSE, &i);
}
...
void Browser_init()
{
	MENUITEMINFO i = {sizeof(i), MIIM_ID | MIIM_STATE | MIIM_TYPE, MFT_STRING, MFS_UNCHECKED, WINLAMP_BROWSER_ID};
