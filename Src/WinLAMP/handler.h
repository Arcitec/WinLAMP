...
static const GUID winlamp_uri_handler_guid = 
{ 0x800a9a73, 0x8891, 0x4892, { 0xae, 0xeb, 0xff, 0x97, 0xb, 0x16, 0xa3, 0x9d } };


class WinLAMPURIHandler : public svc_urihandler
{
public:
	static const char *getServiceName() { return "WinLAMP URI Handler"; }
	static GUID getServiceGuid() { return winlamp_uri_handler_guid; } 
	...
	int RegisterProtocol(const wchar_t *protocol, const wchar_t *winlampexe);
