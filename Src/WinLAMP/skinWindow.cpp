...
static void SkinnedWindow_OnWinLAMPCustomClose(SKINNEDWND *pWnd, POINTS pts)
{
...
static LRESULT SkinnedWindow_OnWinLAMPIPC(SKINNEDWND *pWnd, UINT uCmd, WPARAM param)
{
	switch(uCmd)
	{
...
static LRESULT CALLBACK SkinnedWnd_WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	switch(uMsg)
	{
		...
		case WAMSG_CLOSE:		SkinnedWindow_OnWinLAMPCustomClose(pWnd, MAKEPOINTS(lParam)); return 0;
		...
		case WM_WA_IPC:			return SkinnedWindow_OnWinLAMPIPC(pWnd, (UINT)lParam, wParam);
