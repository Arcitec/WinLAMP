...
{
	return ButtonPress(WINLAMP_BUTTON1, L"controls", wFlags, pdispparams, pvarResult, puArgErr);
}

HRESULT JSAPI2::TransportAPI::Play(WORD wFlags, DISPPARAMS FAR *pdispparams, VARIANT FAR *pvarResult, unsigned int FAR *puArgErr)
{
	return ButtonPress(WINLAMP_BUTTON2, L"controls", wFlags, pdispparams, pvarResult, puArgErr);
}
...
{
	return ButtonPress(WINLAMP_BUTTON3, L"controls", wFlags, pdispparams, pvarResult, puArgErr);
}

HRESULT JSAPI2::TransportAPI::Stop(WORD wFlags, DISPPARAMS FAR *pdispparams, VARIANT FAR *pvarResult, unsigned int FAR *puArgErr)
{
	return ButtonPress(WINLAMP_BUTTON4, L"controls", wFlags, pdispparams, pvarResult, puArgErr);
}

HRESULT JSAPI2::TransportAPI::Next(WORD wFlags, DISPPARAMS FAR *pdispparams, VARIANT FAR *pvarResult, unsigned int FAR *puArgErr)
{
	return ButtonPress(WINLAMP_BUTTON5, L"controls", wFlags, pdispparams, pvarResult, puArgErr);
}
