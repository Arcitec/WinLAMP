...
{	
	...
	switch (uMsg)
	{
		...
		case WM_COMMAND:
		{
			switch (LOWORD(wParam))
			{
				...
				{
					myOpenURLWithFallback(hwndDlg,L"http://www.google.com/search?q=%22winlamp+skins%22", L"http://www.google.com/search?q=%22winlamp+skins%22");
					return 0;
				}
				case IDC_RANDOM:
				{
	...
	{
		myOpenURLWithFallback(hwndDlg, L"http://www.google.com/search?q=%22winlamp+plugins%22", L"http://www.winlamp.com/plugins");
	}
