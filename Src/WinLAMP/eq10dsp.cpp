...
static double eq10_freq[EQ10_NOFBANDS]={ 70, 180, 320, 600, 1000, 3000, 6000, 12000, 14000, 16000 }; // winlamp style frequency table;
...
#ifndef EQ10_DQ
					eq10_bsetup(rate,&eq->band[t],(config_eq_frequencies==EQ_FREQUENCIES_WINLAMP)?eq10_freq[t]:eq10_freq_iso[t],EQ10_Q);
#else
            eq10_bsetup(rate,&eq->band[t],(config_eq_frequencies==EQ_FREQUENCIES_WINLAMP)?eq10_freq[t]:eq10_freq_iso[t],eq10_q[t]);
#endif
