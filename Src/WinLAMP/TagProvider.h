...
static const GUID WinLAMPTagProviderGUID = 
...
public:
  TagProviderFactory() : waServiceBase<ifc_tagprovider, TagProviderFactory>(WinLAMPTagProviderGUID) {}
  static const char *getServiceName() { return "WinLAMP Tag Provider"; }
