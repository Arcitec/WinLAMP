...
#ifndef WINLAMP_FILE
#define REGISTRY_PREFIX "WinLAMP"
#endif

#define WIDEN2(x) L ## x
#define WIDEN(x) WIDEN2(x)

#define WINLAMP_FILE REGISTRY_PREFIX ".File"
#define WINLAMP_FILEW WIDEN(REGISTRY_PREFIX) L".File"
#define WINLAMP_PLAYLIST REGISTRY_PREFIX ".PlayList"
#define WINLAMP_PLAYLISTW WIDEN(REGISTRY_PREFIX) L".PlayList"
#define WINLAMP_SKINZIP REGISTRY_PREFIX ".SkinZip"
#define WINLAMP_SKINZIPW WIDEN(REGISTRY_PREFIX) L".SkinZip"
#define WINLAMP_LANGZIP REGISTRY_PREFIX ".LangZip"
#define WINLAMP_LANGZIPW WIDEN(REGISTRY_PREFIX) L".LangZip"
#define WINLAMP_PLAY REGISTRY_PREFIX ".Play"
#define WINLAMP_PLAYW WIDEN(REGISTRY_PREFIX) L".Play"
#define WINLAMP_ENQUEUE REGISTRY_PREFIX ".Enqueue"
#define WINLAMP_ENQUEUEW WIDEN(REGISTRY_PREFIX) L".Enqueue"
#define WINLAMP_BOOKMARK REGISTRY_PREFIX ".Bookmark"
#define WINLAMP_BOOKMARKW WIDEN(REGISTRY_PREFIX) L".Bookmark"
...
//CONFIG_EXT int config_video_auto_fs DEF_VAL(0); // plague> moved to WinLAMPAttributes.h
