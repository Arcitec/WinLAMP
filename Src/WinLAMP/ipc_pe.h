...
**
** Note:
**      This IS the OPPOSITE way to how the messages to the main winlamp window are sent
**      SendMessageW(hwnd_winlamp,WM_WA_IPC,(parameter),IPC_*);
*/
...
** {
**   playlist_wnd = FindWindow("WinLAMP PE",0);
** }
*/
...
**       SendMessageW(plugin.hwndParent,WM_COMMAND,MAKEWPARAM(WINLAMP_BUTTON2,0),0);
**     }
**   }
*/
