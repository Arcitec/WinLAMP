...
//#define CLASSIC_SKIN_NAME L"WinLAMP Classic"
#define MODERN_SKIN_NAME	L"WinLAMP Modern"
...
#define BIG_BENTO_SKIN_NAME L"Big Bento"
	...
	*/
	...
	unsigned int burn_doBurn(char *cmdline, HWND winlampWnd, HINSTANCE winlampInstance);
	...
	*/ 
	...
	void config_remove_winlamp_keys(void);
...
#define EMBED_STATE_EXTRA_FFROOTWND 63
	...
	*** equi.c 
	*/
	extern int minimize_hack_winlamp;
