...
initDrawer(Layout lay, String name) {
    ...
    __maximized = getPrivateInt("winlamp5", __myname+"Maximized", 0);
    if (__maximized) {
      onBeforeMaximize();
      onAfterMaximize();
    }

    __oldx=getPrivateInt("winlamp5", __myname+"ox", 0);
    __oldy=getPrivateInt("winlamp5", __myname+"oy", 0);
    __oldw=getPrivateInt("winlamp5", __myname+"ow", 0);
    __oldh=getPrivateInt("winlamp5", __myname+"oh", 0);
    __last_forcedtop = getPrivateInt("winlamp5", __myname+"ForcedTop", 0);
    __last_forcedbottom = getPrivateInt("winlamp5", __myname+"ForcedBottom", 0);
}
...
Int isDrawerToTop() {
  ...
  int curstate = getPrivateInt("winlamp5", __myname+"OpenState", CLOSED);
  if (curstate != CLOSED) return __last_forcedtop;

  int h=getPrivateInt("winlamp5", __myname+"Height", getDefaultDrawerOpenHeight());
...
__main.onTargetReached() {
    ...
    if (__drawer_direction == DIRECTION_OPENING) {
        setPrivateInt("winlamp5", __myname+"OpenState", OPEN);
        drawer_showWindowContent();
        onDoneOpeningDrawer();
    } else if (__drawer_direction == DIRECTION_CLOSING) {
        setPrivateInt("winlamp5", __myname+"OpenState", CLOSED);
        onDoneClosingDrawer();
    }
    __drawer_direction = DIRECTION_NONE;
}
...
drawer_expandWindow(int withdrawer) {
    ...
    if (!__maximized)
      setPrivateInt("winlamp5", __myname+"Height", h);
    setPrivateInt("winlamp5", __myname+"ForcedBottom", __last_forcedBottom);
    setPrivateInt("winlamp5", __myname+"ForcedTop", __last_forcedtop);
}
...
drawer_reduceWindow(int withdrawer) {
    ...
    __last_forcedtop = 0;
    __last_forcedbottom = 0;
    setPrivateInt("winlamp5", __myname+"ForcedBottom", 0);
    setPrivateInt("winlamp5", __myname+"ForcedTop", 0);
}
...
openDrawer() {
    ...
    if (s == STATUS_PLAYING || s == STATUS_PAUSED) {
        ...
        int Window_Content=getPrivateInt("winlamp5", __myname+"State", CONTENT_VIS);
...
System.onPlay() {
    ...
    WinLAMPConfigGroup vidwcg = WinLAMPConfig.getGroup(VIDEO_CONFIG_GROUP);
...
System.onGetCancelComponent(String guid, boolean goingvisible) {
    ...
    DebugString(" Last Content : " + IntegerToString(getPrivateInt("winlamp5", __myname+"State", CONTENT_VIS)), 0);
    DebugString(" Drawer State : " + IntegerToString(getPrivateInt("winlamp5", __myname+"OpenState", CLOSED)), 0);
    DebugString("-----------------------------------------------------", 0);
#endif
    ...
    int Window_Content=getPrivateInt("winlamp5", __myname+"State", CONTENT_VIS);
    int window_status =getPrivateInt("winlamp5", __myname+"OpenState", CLOSED);
...
drawer_showVis() {
    ...
    __showing_vis = 1;
    setPrivateInt("winlamp5", __myname+"OpenState", OPEN);
    setPrivateInt("winlamp5", __myname+"State", CONTENT_VIS);
...
drawer_showVideo() {
    ...
    __showing_video = 1;
    setPrivateInt("winlamp5", __myname+"OpenState", OPEN);
    setPrivateInt("winlamp5", __myname+"State", CONTENT_VIDEO);
...
// -----------------------------------------------------------------------
drawer_showWindowContent() {
    int lastWindowContent=getPrivateInt("winlamp5", __myname+"State", 2);
#ifdef DEBUG
...
// -----------------------------------------------------------------------
OpenDrawerForNothing() {
    setPrivateInt("winlamp5", __myname+"State", CONTENT_NOTHING);
    drawer_expandWindow(1);
}
...
__main.onResize(int x, int y, int w, int h) {
    if (!isGoingToTarget() && !__isinited) {
        __isinited = 1;
        if (h > getDrawerClosedHeight()) { setPrivateInt("winlamp5", __myname+"OpenState", OPEN); drawer_expandWindow(0); }
        else setPrivateInt("winlamp5", __myname+"OpenState", CLOSED);
    }
}
...
__main.onUserResize(int x, int y, int w, int h) {
    ...
    if (__maximized) {
      __maximized = 0;
      setPrivateInt("winlamp5", __myname+"Maximized", 0);
      onCancelMaximize();
    }
}
...
drawer_doAttachVideo() {
    ...
    if (wasvisible) {
        ...
        int window_status =getPrivateInt("winlamp5", __myname+"OpenState", CLOSED);
        int window_content=getPrivateInt("winlamp5", __myname+"State", 2);
...
// -----------------------------------------------------------------------
Int getDrawerState() {
    return getPrivateInt("winlamp5", __myname+"OpenState", CLOSED);
}

// -----------------------------------------------------------------------
Int getDrawerContent() {
    return getPrivateInt("winlamp5", __myname+"State", CONTENT_VIS);
}
...
maximizeWindow() {
  ...
  setPrivateInt("winlamp5", __myname+"ox", __oldx);
  setPrivateInt("winlamp5", __myname+"oy", __oldy);
  setPrivateInt("winlamp5", __myname+"ow", __oldw);
  setPrivateInt("winlamp5", __myname+"oh", __oldh);
...
drawer_doMaximizeWindow(int notif) {
  ...
  __maximized = 1;
  setPrivateInt("winlamp5", __myname+"Maximized", 1);
