@echo *******************************
@echo * Delete Release, Debug folders and files for winlampAll_2019.sln
@echo *******************************
@echo -------------------------------
@echo *******************************
@echo * winlampAll project
@echo *******************************
@if exist .vs (
	@echo Delete .vs
	@call rd /S /Q .vs
...
@echo -------------------------------
@echo *******************************
@echo * WinLAMP project
@echo *******************************
@if exist ..\WinLAMP\x86_Debug (
	@echo Delete ..\WinLAMP\x86_Debug
	@call rd /S /Q ..\WinLAMP\x86_Debug
	)
@if exist ..\WinLAMP\x86_Release (
	@echo Delete ..\WinLAMP\x86_Release
	@call rd /S /Q ..\WinLAMP\x86_Release
	)
@if exist ..\WinLAMP\x64_Debug (
	@echo Delete ..\WinLAMP\x64_Debug
	@call rd /S /Q ..\WinLAMP\x64_Debug
	)
@if exist ..\WinLAMP\x64_Release (
	@echo Delete ..\WinLAMP\x64_Release
	@call rd /S /Q ..\WinLAMP\x64_Release
	)
@if exist ..\WinLAMP\.vs (
	@echo Delete ..\WinLAMP\.vs
	@call rd /S /Q ..\WinLAMP\.vs
	)
@if exist ..\WinLAMP\*.user (
	@echo Delete ..\WinLAMP\*.user
	@call del ..\WinLAMP\*.user
	)
@if exist ..\WinLAMP\*.filters (
	@echo Delete ..\WinLAMP\*.filters
	@call del ..\WinLAMP\*.filters
	)
@if exist ..\WinLAMP\*.htm (
	@echo Delete ..\WinLAMP\*.htm
	@call del ..\WinLAMP\*.htm
	)	
@echo -------------------------------
@echo *******************************
@echo * winlampa project
@echo *******************************
@if exist ..\winlampa\x86_Debug (
	@echo Delete ..\winlampa\x86_Debug
	@call rd /S /Q ..\winlampa\x86_Debug
	)
@if exist ..\winlampa\x86_Release (
	@echo Delete ..\winlampa\x86_Release
	@call rd /S /Q ..\winlampa\x86_Release
	)
@if exist ..\winlampa\x64_Debug (
	@echo Delete ..\winlampa\x64_Debug
	@call rd /S /Q ..\winlampa\x64_Debug
	)
@if exist ..\winlampa\x64_Release (
	@echo Delete ..\winlampa\x64_Release
	@call rd /S /Q ..\winlampa\x64_Release
	)
@if exist ..\winlampa\.vs (
	@echo Delete ..\winlampa\.vs
	@call rd /S /Q ..\winlampa\.vs
	)
@if exist ..\winlampa\*.user (
	@echo Delete ..\winlampa\*.user
	@call del ..\winlampa\*.user
	)
@if exist ..\winlampa\*.filters (
	@echo Delete ..\winlampa\*.filters
	@call del ..\winlampa\*.filters
	)
@if exist ..\winlampa\*.htm (
	@echo Delete ..\winlampa\*.htm
	@call del ..\winlampa\*.htm
	)
@echo -------------------------------
@echo *******************************
@echo * xml project
