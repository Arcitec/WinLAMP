...
@echo ************************************
@echo * Build winlampAll_2019.sln Debug x86
@echo ************************************
call "c:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvars32.bat"
@@msbuild winlampAll_2019.sln /p:Configuration=Debug /p:Platform="Win32"

@echo **************************************
@echo * Build winlampAll_2019.sln Release x86
@echo **************************************
call "c:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvars32.bat"
@@msbuild winlampAll_2019.sln /p:configuration=Release /p:Platform="Win32"

@echo ************************************
@echo * Build winlampAll_2019.sln Debug x64
@echo ************************************
call "c:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvars64.bat"
@@msbuild winlampAll_2019.sln /p:configuration=Debug /p:Platform="x64"

@echo **************************************
@echo * Build winlampAll_2019.sln Release x64
@echo ************************************** 
call "c:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvars64.bat"
@@msbuild winlampAll_2019.sln /p:configuration=Release /p:Platform="x64"
