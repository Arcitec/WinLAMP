...
** result = SendMessage(hwnd_winlamp,WM_WA_IPC,(parameter),IPC_*);
** Where different then this is specified (typically with WM_COPYDATA variants)
**
** When you use SendMessage(hwnd_winlamp,WM_WA_IPC,(parameter),IPC_*) and specify a IPC_*
...
/* int version = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETVERSION);
**
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETREGISTEREDVERSION);
**
...
**   SendMessage(hwnd_winlamp,WM_COPYDATA,0,(LPARAM)&cds);
**
**
...
**   SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)&eFWMS,IPC_ENQUEUEFILE);
*/


#define IPC_DELETE 101
#define IPC_DELETE_INT 1101 
/* SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_DELETE);
...
/* SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_STARTPLAY);
...
/* int res = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_ISPLAYING);
...
/* int res = SendMessage(hwnd_winlamp,WM_WA_IPC,mode,IPC_GETOUTPUTTIME);
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,ms,IPC_JUMPTOTIME);
...
** int cur = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_WRITEPLAYLIST);
**
** IPC_WRITEPLAYLIST will write the current playlist to '<winlampdir>\\WinLAMP.m3u' and
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,position,IPC_SETPLAYLISTPOS)
...
**
** If you use SendMessage(hwnd_winlamp,WM_COMMAND,MAKEWPARAM(WINLAMP_BUTTON2,0),0);
...
/* (requires WinLAMP 2.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,volume,IPC_SETVOLUME);
...
** int curvol = SendMessage(hwnd_winlamp,WM_WA_IPC,-666,IPC_SETVOLUME);
*/


#define IPC_GETVOLUME(hwnd_winlamp) SendMessage(hwnd_winlamp,WM_WA_IPC,-666,IPC_SETVOLUME)
/* (requires WinLAMP 2.0+)
** int curvol = IPC_GETVOLUME(hwnd_winlamp);
** This will return the current volume of WinLAMP or 
*/


#define IPC_SETPANNING 123
/* (requires WinLAMP 2.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,panning,IPC_SETPANNING);
...
** int curpan = SendMessage(hwnd_winlamp,WM_WA_IPC,-666,IPC_SETPANNING);
*/


#define IPC_GETLISTLENGTH 124
/* (requires WinLAMP 2.0+)
** int length = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETLISTLENGTH);
...
** int pos=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETLISTPOS);
...
/* (requires WinLAMP 2.05+)
** int inf=SendMessage(hwnd_winlamp,WM_WA_IPC,mode,IPC_GETINFO);
...
/* (requires WinLAMP 2.05+)
** int data=SendMessage(hwnd_winlamp,WM_WA_IPC,pos,IPC_GETEQDATA);
...
/* (requires WinLAMP 2.05+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,pos,IPC_GETEQDATA);
** SendMessage(hwnd_winlamp,WM_WA_IPC,value,IPC_SETEQDATA);
...
**
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(char*)"filename\0title\0",IPC_ADDBOOKMARK);
**
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_RESTARTWINLAMP);
...
** int ret=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_ISFULLSTOP);
...
/* (requires WinLAMP 2.05+)
** int val=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_INETAVAILABLE);
...
/* (requires WinLAMP 2.2+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_UPDTITLE);
...
/* (requires WinLAMP 2.2+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_REFRESHPLCACHE);
...
/* (requires WinLAMP 2.4+)
** int val=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GET_SHUFFLE);
...
/* (requires WinLAMP 2.4+)
** int val=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GET_REPEAT);
...
/* (requires WinLAMP 2.4+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,value,IPC_SET_SHUFFLE);
...
/* (requires WinLAMP 2.4+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,value,IPC_SET_REPEAT);
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,(enable?0:0xdeadbeef),IPC_ENABLEDISABLE_ALL_WINDOWS);
...
/* (requires WinLAMP 2.9+)
** HWND h=SendMessage(hwnd_winlamp,WM_WA_IPC,IPC_GETWND_xxx,IPC_GETWND);
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)"skinname",IPC_SETSKIN);
...
/* (requires WinLAMP 2.04+, only usable from plug-ins (not external apps))
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)skinname_buffer,IPC_GETSKIN);
...
/* (requires WinLAMP 2.04+, only usable from plug-ins (not external apps))
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)"vis_file.dll",IPC_EXECPLUG);
...
/* (requires WinLAMP 2.04+, only usable from plug-ins (not external apps))
** char *name=SendMessage(hwnd_winlamp,WM_WA_IPC,index,IPC_GETPLAYLISTFILE);
...
/* (requires WinLAMP 2.04+, only usable from plug-ins (not external apps))
** char *name=SendMessage(hwnd_winlamp,WM_WA_IPC,index,IPC_GETPLAYLISTTITLE);
**
...
/* (requires WinLAMP 2.05+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_MBOPEN);
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)url,IPC_MBOPEN);
...
/* (requires WinLAMP 2.05+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)file,IPC_CHANGECURRENTFILE);
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)file,IPC_CHANGECURRENTFILEW);
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)buffer,IPC_GETMBURL);
...
/* (requires WinLAMP 2.4+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,value,IPC_MBBLOCK);
**
...
/* (requires WinLAMP 2.4+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)url,IPC_MBOPENREAL);
**
...
/* (requires WinLAMP 2.9+)
** int newpos=SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)adjust_offset,IPC_ADJUST_OPTIONSMENUPOS);
** moves where winlamp expects the Options menu in the main menu. Useful if you wish to insert a
...
/* (requires WinLAMP 2.9+)
** HMENU hMenu=SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)0,IPC_GET_HMENU);
** values for data:
** 0 : main popup menu 
...
** length of that buffer, and then SendMessage(hwnd_winlamp,WM_WA_IPC,&struct,IPC_GET_EXTENDED_FILE_INFO);
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,&struct,IPC_SET_EXTENDED_FILE_INFO);
...
/* (requires WinLAMP 2.9+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)&prefsRec,IPC_ADD_PREFS_DLG);
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)&prefsRec,IPC_REMOVE_PREFS_DLG);
**
** IPC_ADD_PREFS_DLG:
...
**
** Then you do SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)&prefsRec,IPC_ADD_PREFS_DLG);
**
** example:
**
...
/* SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)&prefsRec,IPC_OPENPREFSTOPAGE);
**
...
/* (requires WinLAMP 2.9+)
** char *ini=(char*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETINIFILE);
** This returns a pointer to the full file path of winlamp.ini.
**
** char ini_path[MAX_PATH] = {0};
**
** void GetIniFilePath(HWND hwnd){
**   if(SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETVERSION) >= 0x2900){
**     // this gets the string of the full ini file path
**     lstrcpyn(ini_path,(char*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETINIFILE),sizeof(ini_path));
**   }
**   else{
**   char* p = ini_path;
...
/* (requires WinLAMP 2.9+)
** char *dir=(char*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETINIDIRECTORY);
...
** char *plugdir=(char*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETPLUGINDIRECTORY);
...
/* (requires WinLAMP 5.11+)
** char *m3udir=(char*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETM3UDIRECTORY);
...
/* (requires WinLAMP 5.3+)
** wchar_t *m3udirW=(wchar_t*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETM3UDIRECTORYW);
** This returns a pointer to the directory where winlamp.m3u (and winlamp.m3u8 if supported) is stored in.
*/
...
/* (requires WinLAMP 5.0+)
** HGLOBAL hglobal = (HGLOBAL)SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(HWND)parent,IPC_OPENURLBOX);
...
/* (requires WinLAMP 5.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(HWND)parent,IPC_OPENFILEBOX);
** You pass a hwnd for the dialog to be parented to (which modern skin support uses).
*/
...
/* (requires WinLAMP 5.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(HWND)parent,IPC_OPENDIRBOX);
** You pass a hwnd for the dialog to be parented to (which modern skin support uses).
*/
...
/* (requires WinLAMP 5.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(HWND)parent,IPC_SETDIALOGBOXPARENT);
...
** HWND hwndParent = SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)0, IPC_GETDIALOGBOXPARENT);
** hwndParent can/must be passed to all modal dialogs (including MessageBox) thats uses winlamp as a parent
*/
...
typedef struct
{
  ...
  int extra_data[64];   // for internal winlamp use
} embedWindowState;

#define IPC_GET_EMBEDIF 505
/* (requires WinLAMP 2.9+)
** HWND myframe = (HWND)SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)&wa_wnd,IPC_GET_EMBEDIF);
**
** or
**
** HWND myframe = 0;
** HWND (*embed)(embedWindowState *params)=0;
**   *(void**)&embed = (void*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GET_EMBEDIF);
...
/* (requires WinLAMP 2.9+)
** int valid = SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)embedhwnd,IPC_EMBED_ISVALID);
...
**
** eg: SendMessage(hwnd_winlamp,WM_WA_IPC,&myConvertStruct,IPC_CONVERTFILE);
**
** Return value:
...
**
** eg: SendMessage(hwnd_winlamp,WM_WA_IPC,&myConvertStruct,IPC_CONVERTFILE_END);
**
** No return value
*/
...
/* (requires WinLAMP 5.0+)
** int visible=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_ISMAINWNDVISIBLE);
...
** {
**   if(SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_ISPLAYING) == 1 &&
**      !SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETOUTPUTTIME))
**   {
**     char* file = (char*)SendMessage(hwnd_winlamp,WM_WA_IPC,
**                  SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETLISTPOS),IPC_GETPLAYLISTFILE);
...
/* (requires WinLAMP 2.9+)
** int newpos=SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)adjust_offset,IPC_ADJUST_FFWINDOWSMENUPOS);
...
/* (requires WinLAMP 5.0+)
** int dsize=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_ISDOUBLESIZE);
...
/* (requires WinLAMP 2.9+)
** int newpos=SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)adjust_offset,IPC_ADJUST_FFOPTIONSMENUPOS);
...
/* (requires WinLAMP 5.0+)
** int mode=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETTIMEDISPLAYMODE);
...
/* (requires WinLAMP 5.0+)
** int viswnd=(HWND)SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(HWND)viswnd,IPC_SETVISWND);
...
/* (requires WinLAMP 5.0+)
** int viswnd=(HWND)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETVISWND);
...
/* (requires WinLAMP 5.0+)
** int visrunning=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_ISVISRUNNING);
...
/* (requires WinLAMP 5.0+)
** int sovc=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETSTOPONVIDEOCLOSE);
...
/* (requires WinLAMP 5.0+)
** int sovc=SendMessage(hwnd_winlamp,WM_WA_IPC,enabled,IPC_SETSTOPONVIDEOCLOSE);
...
/* (requires WinLAMP 5.0+)
** HWND prefs = (HWND)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETPREFSWND);
...
** SendMessage(hwnd_winlamp,WM_COMMAND,MAKEWPARAM(WINLAMP_OPTIONS_PREFS,0),0);
** MessageBox(hwnd_winlamp,(IsWindow((HWND)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETPREFSWND))?"Valid":"Not Open"),0,MB_OK);
*/


#define IPC_SET_PE_WIDTHHEIGHT 620
/* (requires WinLAMP 5.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)&point,IPC_SET_PE_WIDTHHEIGHT);
...
/* (requires WinLAMP 5.0+)
** HINSTANCE hInst = (HINSTANCE)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETLANGUAGEPACKINSTANCE);
...
** if(!SendMessage(hwnd_winlamp,WM_WA_IPC,1,IPC_GETLANGUAGEPACKINSTANCE)){
**   // winlamp is currently using a language pack
** }
**
** If you pass 2 in wParam then you will get the path to the language pack folder.
** wchar_t* lngpackfolder = (wchar_t*)SendMessage(hwnd_winlamp,WM_WA_IPC,2,IPC_GETLANGUAGEPACKINSTANCE);
**
** If you pass 3 in wParam then you will get the path to the currently extracted language pack.
** wchar_t* lngpack = (wchar_t*)SendMessage(hwnd_winlamp,WM_WA_IPC,3,IPC_GETLANGUAGEPACKINSTANCE);
**
** If you pass 4 in wParam then you will get the name of the currently used language pack.
** wchar_t* lngname = (char*)SendMessage(hwnd_winlamp,WM_WA_IPC,4,IPC_GETLANGUAGEPACKINSTANCE);
*/
...
**
** wchar_t* ident_str = (wchar_t*)SendMessage(hwnd_winlamp,WM_WA_IPC,MAKEWPARAM(5,LANG_XXX),IPC_GETLANGUAGEPACKINSTANCE);
**
** e.g.
...
**
** HINSTANCE lang = (HINSTANCE)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETLANGUAGEPACKINSTANCE);
...
/* (requires WinLAMP 5.0+)
** char* outdll = (char*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETOUTPUTPLUGIN);
...
/* (requires WinLAMP 5.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,enabled,IPC_SETDRAWBORDERS);
...
/* (requires WinLAMP 5.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,enabled,IPC_DISABLESKINCURSORS);
...
/* (requires WinLAMP 5.0+)
** int val=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_IS_FULLSCREEN);
...
** int val=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GET_MANUALPLADVANCE);
...
/* (requires WinLAMP 5.03+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,value,IPC_SET_MANUALPLADVANCE);
...
/* (requires WinLAMP 5.04+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_EOF_GET_NEXT_PLITEM);
**
...
/* (requires WinLAMP 5.04+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_EOF_GET_PREVIOUS_PLITEM);
**
...
/* (requires WinLAMP 5.04+)
** int is_shaded=SendMessage(hwnd_winlamp,WM_WA_IPC,wnd,IPC_IS_WNDSHADE);
...
** int rating=SendMessage(hwnd_winlamp,WM_WA_IPC,rating,IPC_SETRATING);
...
** int cur_pos=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETLISTPOS);
**   SendMessage(hwnd_winlamp,WM_WA_IPC,item_to_set,IPC_SETPLAYLISTPOS);
**   SendMessage(hwnd_winlamp,WM_WA_IPC,rating_to_set,IPC_SETRATING);
**   SendMessage(hwnd_winlamp,WM_WA_IPC,cur_pos,IPC_SETPLAYLISTPOS);
** }
*/
...
/* (requires WinLAMP 5.04+ with ML)
** int rating=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETRATING);
...
** int cur_pos=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETLISTPOS), rating = 0;
**   SendMessage(hwnd_winlamp,WM_WA_IPC,item_to_get,IPC_SETPLAYLISTPOS);
**   rating = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETRATING);
**   SendMessage(hwnd_winlamp,WM_WA_IPC,cur_pos,IPC_SETPLAYLISTPOS);
**   return rating;
** }
*/
...
/* (requires WinLAMP 5.04+)
** int n = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETNUMAUDIOTRACKS);
...
/* (requires WinLAMP 5.04+)
** int n = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETNUMVIDEOTRACKS);
...
/* (requires WinLAMP 5.04+)
** int cur = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETAUDIOTRACK);
...
/* (requires WinLAMP 5.04+)
** int cur = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETVIDEOTRACK);
...
/* (requires WinLAMP 5.04+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,track,IPC_SETAUDIOTRACK);
...
/* (requires WinLAMP 5.04+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,track,IPC_SETVIDEOTRACK);
...
/* (requires WinLAMP 5.04+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_PUSH_DISABLE_EXIT);
...
/* (requires WinLAMP 5.04+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_POP_DISABLE_EXIT);
...
/* (requires WinLAMP 5.04+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_IS_EXIT_ENABLED);
...
/* (requires WinLAMP 5.04+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_IS_AOT);
...
** int use_bin=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_USES_RECYCLEBIN);
...
**
** if(SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_USES_RECYCLEBIN) &&
**    SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETVERSION)>=0x5009)
** {
...
/*
** SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_FLUSHAUDITS);
** 
...
/* (requires WinLAMP 5.36+)
** int show_state = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_INITIAL_SHOW_STATE);
...
**
** e.g.
** if(SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_INITIAL_SHOW_STATE) == SW_SHOWMINIMIZED){
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(const char*)colour_theme_name,IPC_FF_ONCOLORTHEMECHANGED);
**
...
/*
** int ismainwnd = (HWND)SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(HWND)test_wnd,IPC_FF_ISMAINWND);
**
...
**
**   if(SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)hwnd,IPC_FF_ISMAINWND)){
...
/*
** HWND wa2embed = (HWND)SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(HWND)test_wnd,IPC_FF_GETCONTENTWND);
**
...
** SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(const char*)hotkey_desc,IPC_FF_NOTIFYHOTKEY);
*/
...
/* (requires WinLAMP 5.0+)
** IDropTarget* IDrop = (IDropTarget*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GETDROPTARGET);
**
...
/* (requires WinLAMP 5.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,allow,IPC_ALLOW_PLAYTRACKING);
...
/* (requires WinLAMP 5.0+)
** SendMessage(hwnd_winlamp,WM_WA_IPC,write_type,IPC_WRITECONFIG);
**
...
/* (requires WinLAMP 5.1+)
** int changed=SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)(char*)field,IPC_METADATA_CHANGED);
** a plugin can SendMessage this to winlamp if internal metadata has changes.
...
/* (requires WinLAMP 5.1+)
** WORD id = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_REGISTER_LOWORD_COMMAND);
...
/* (requires WinLAMP 5.11+)
** char* proxy_string=(char*)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GET_PROXY_STRING);
...
/* (requires WinLAMP 5.11+)
** int reg_enabled=SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_USE_REGISTRY);
...
** api_service* api_service = (api_service)SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_GET_API_SERVICE);
...
/* (requires 5.2+)
** int pl_item = SendMessage(hwnd_winlamp,WM_WA_IPC,start,IPC_PLAYLIST_GET_NEXT_SELECTED);
**
...
** while((sel = SendMessage(hwnd_winlamp,WM_WA_IPC,sel,IPC_PLAYLIST_GET_NEXT_SELECTED))!=-1){
**   // show the playlist file entry of the selected item(s) if there were any
**   MessageBox(hwnd_winlamp,(char*)SendMessage(hwnd_winlamp,WM_WA_IPC,sel,IPC_GETPLAYLISTFILE),0,0);
** }
*/
...
/* (requires 5.2+)
** int selcnt = SendMessage(hwnd_winlamp,WM_WA_IPC,0,IPC_PLAYLIST_GET_SELECTED_COUNT);
...
** int ret = SendMessage(hwnd_winlamp,WM_WA_IPC,param,IPC_USE_UXTHEME_FUNC);
...
** int isthemethere = !SendMessage(hwnd_winlamp,WM_WA_IPC,IPC_ISWINTHEMEPRESENT,IPC_USE_UXTHEME_FUNC);
*/
  #define IPC_ISAEROCOMPOSITIONACTIVE 1
/* This will return 0 if aero composition is active
** int isaero = !SendMessage(hwnd_winlamp,WM_WA_IPC,IPC_ISAEROCOMPOSITIONACTIVE,IPC_USE_UXTHEME_FUNC);
*/
...
/* (requires WinLAMP 5.0+)
** DWORD id = SendMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)name,IPC_REGISTER_WINLAMP_IPCMESSAGE);
...
** e.g.
**   PostMessage(hwnd_winlamp,WM_WA_IPC,(WPARAM)my_param,registered_ipc);
