#ifndef _NULLSOFT_WINLAMP_ML_PORTABLES_GRAPHICS_HEADER
#define _NULLSOFT_WINLAMP_ML_PORTABLES_GRAPHICS_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_PORTABLES_GRAPHICS_HEADER
