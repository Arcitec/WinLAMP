#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_FILL_REGION_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_FILL_REGION_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_FILL_REGION_HEADER