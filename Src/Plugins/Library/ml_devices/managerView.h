#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_MANAGER_VIEW_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_MANAGER_VIEW_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_MANAGER_VIEW_HEADER