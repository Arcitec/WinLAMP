#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_NAVIGATION_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_NAVIGATION_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_NAVIGATION_HEADER
