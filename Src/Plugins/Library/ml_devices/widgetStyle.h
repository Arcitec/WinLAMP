#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_WIDGETSTYLE_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_WIDGETSTYLE_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_WIDGETSTYLE_HEADER
