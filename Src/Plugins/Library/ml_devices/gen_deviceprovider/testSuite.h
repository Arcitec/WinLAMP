#ifndef _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_TEST_SUITE_HEADER
#define _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_TEST_SUITE_HEADER
...
#endif // _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_TEST_SUITE_HEADER