#ifndef _NULLSOFT_WINLAMP_GEN_DEVICE_ICON_STORE_HEADER
#define _NULLSOFT_WINLAMP_GEN_DEVICE_ICON_STORE_HEADER
...
#endif //_NULLSOFT_WINLAMP_GEN_DEVICE_ICON_STORE_HEADER