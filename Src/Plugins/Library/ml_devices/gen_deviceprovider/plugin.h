#ifndef _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_PLUGIN_HEADER
#define _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_PLUGIN_HEADER
...
#endif //_NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_PLUGIN_HEADER
