#ifndef _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_DEVICE_CONNECTION_PARSER_HEADER
#define _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_DEVICE_CONNECTION_PARSER_HEADER
...
#endif // _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_DEVICE_CONNECTION_PARSER_HEADER