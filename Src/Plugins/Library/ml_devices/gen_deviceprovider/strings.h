#ifndef _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_STRINGS_HEADER
#define _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_STRINGS_HEADER
...
#endif //_NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_STRINGS_HEADER