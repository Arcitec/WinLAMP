#ifndef _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_COMMON_HEADER
#define _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_COMMON_HEADER
...
#endif //_NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_COMMON_HEADER
