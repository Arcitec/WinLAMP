#ifndef _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_SUPPORTED_COMMAND_HEADER
#define _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_SUPPORTED_COMMAND_HEADER
...
#endif //_NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_SUPPORTED_COMMAND_HEADER