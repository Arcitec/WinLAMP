#ifndef _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_IMPLEMENTATION_HEADER
#define _NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_IMPLEMENTATION_HEADER
...
#endif //_NULLSOFT_WINLAMP_GEN_DEVICE_PROVIDER_IMPLEMENTATION_HEADER