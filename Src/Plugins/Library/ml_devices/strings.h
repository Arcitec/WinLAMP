#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_STRINGS_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_STRINGS_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_PLUGIN_STRINGS_HEADER