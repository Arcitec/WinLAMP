#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_DEVICE_HANDLER_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_DEVICE_HANDLER_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_DEVICE_HANDLER_HEADER