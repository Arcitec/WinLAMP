#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_DEVICE_COMMANDS_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_DEVICE_COMMANDS_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_DEVICE_COMMANDS_HEADER