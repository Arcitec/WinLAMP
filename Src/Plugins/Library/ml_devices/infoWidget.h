#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_INFO_WIDGET_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_INFO_WIDGET_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_INFO_WIDGET_HEADER