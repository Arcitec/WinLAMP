#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_LIST_WIDGET_INTERNAL_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_LIST_WIDGET_INTERNAL_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_LIST_WIDGET_INTERNAL_HEADER
