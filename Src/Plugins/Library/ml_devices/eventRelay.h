#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_EVENT_RELAY_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_EVENT_RELAY_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_EVENT_RELAY_HEADER