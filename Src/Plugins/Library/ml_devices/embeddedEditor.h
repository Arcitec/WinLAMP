#ifndef _NULLSOFT_WINLAMP_ML_DEVICES_EMBEDED_EDITOR_HEADER
#define _NULLSOFT_WINLAMP_ML_DEVICES_EMBEDED_EDITOR_HEADER
...
#endif //_NULLSOFT_WINLAMP_ML_DEVICES_EMBEDED_EDITOR_HEADER