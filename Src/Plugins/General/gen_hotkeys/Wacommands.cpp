...
genHotkeysAddStructLocalised WADefCommands[] = {
	{IDS_PLAYBACK__PLAY,{0, 0, WM_COMMAND, WINLAMP_BUTTON2, 0, "ghkdc play"}},
	{IDS_PLAYBACK__PAUSE,{0, 0, WM_COMMAND, WINLAMP_BUTTON3, 0, "ghkdc pause"}},
	{IDS_PLAYBACK__STOP,{0, 0, WM_COMMAND, WINLAMP_BUTTON4, 0, "ghkdc stop"}},
	{IDS_PLAYBACK__PREVIOUS_IN_PLAYLIST,{0, 0, WM_COMMAND, WINLAMP_BUTTON1, 0, "ghkdc prev"}},
	{IDS_PLAYBACK__NEXT_IN_PLAYLIST,{0, 0, WM_COMMAND, WINLAMP_BUTTON5, 0, "ghkdc next"}},
	{IDS_PLAYBACK__VOLUME_UP,{0, 0, WM_COMMAND, WINLAMP_VOLUMEUP, 0, "ghkdc vup"}},
	{IDS_PLAYBACK__VOLUME_DOWN,{0, 0, WM_COMMAND, WINLAMP_VOLUMEDOWN, 0, "ghkdc vdown"}},
	{IDS_PLAYBACK__FORWARD,{0, 0, WM_COMMAND, WINLAMP_FFWD5S, 0, "ghkdc forward"}},
	{IDS_PLAYBACK__REWIND,{0, 0, WM_COMMAND, WINLAMP_REW5S, 0, "ghkdc rewind"}},
	...
	{IDS_UI__TOGGLE_EQ,{0, 0, WM_COMMAND, WINLAMP_OPTIONS_EQ, 0, "ghkdc t eq"}},
	{IDS_UI__TOGGLE_PLAYLIST,{0, 0, WM_COMMAND, WINLAMP_OPTIONS_PLEDIT, 0, "ghkdc t pl"}},
	{IDS_UI__TOGGLE_AOT,{0, 0, WM_COMMAND, WINLAMP_OPTIONS_AOT, 0, "ghkdc t aot"}},
	{IDS_UI__ABOUT,{0, HKF_BRING_TO_FRONT, WM_COMMAND, WINLAMP_HELP_ABOUT, 0, "ghkdc about"}},
	...
	{IDS_PLAYBACK__OPEN_LOC_DIALOG,{0, HKF_BRING_TO_FRONT, WM_COMMAND, WINLAMP_BUTTON2_CTRL, 0, "ghkdc url"}},
	...
	{IDS_PLAYBACK__PLAY_PAUSE,{0, HKF_ISPLAYING_WL, WM_COMMAND, WINLAMP_BUTTON3, WINLAMP_BUTTON2, "ghkdc play/pause"}},
	...
	// removed due to it not being in current winlamp builds now {IDS_UI__TOGGLE_MINIBROWSER,{0, 0, WM_COMMAND, 40298, 0, "ghkdc t mb"}},
	...
	{IDS_PLAYBACK__STOP_WITH_FADEOUT,{0, 0, WM_COMMAND, WINLAMP_BUTTON4_SHIFT, 0, "ghkdc stop fade"}},
	{IDS_PLAYBACK__STOP_AFTER_CURRENT,{0, 0, WM_COMMAND, WINLAMP_BUTTON4_CTRL, 0, "ghkdc stop ac"}},
	{IDS_PLAYBACK__START_OF_LIST,{0, 0, WM_COMMAND, WINLAMP_BUTTON1_CTRL, 0, "ghkdc sol"}},
	{IDS_PLAYBACK__END_OF_LIST,{0, 0, WM_COMMAND, WINLAMP_BUTTON5_CTRL, 0, "ghkdc eol"}},
	...
	// added in 1.4+ so that we can deal with unicode strings on 5.3x+ WinLAMP versions
