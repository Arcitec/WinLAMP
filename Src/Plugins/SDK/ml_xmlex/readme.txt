...
This is an example of implementation of WinLAMP's built in XML parser.  Please make note that WinLAMP's XML service will parse all syntactically correct xml.
