...
@echo.
@echo.
@echo Executing Makensis for WinLAMP Detect [Lang = '%%i'] 
@echo.
@echo.
...
if "%errorlevel%" EQU "0" (
  if /I "%BUILDTYPE%" == "final" (
	...
	call "%CURSANDBOX%\Mastering\WinLAMP\simple_sign.cmd" "!SIGNNAME!" "%CURSANDBOX%\installer\browserplugin\!INSTALLERNAME!_%%i.exe"
  )
) else ( 
